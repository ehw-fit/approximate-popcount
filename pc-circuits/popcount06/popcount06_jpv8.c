...
uint64_t popcount06_jpv8(uint64_t input_a){
  uint8_t popcount06_jpv8_out = 0;
  uint8_t popcount06_jpv8_core_008 = 0;
  uint8_t popcount06_jpv8_core_009 = 0;
  uint8_t popcount06_jpv8_core_010 = 0;
  uint8_t popcount06_jpv8_core_011 = 0;
  uint8_t popcount06_jpv8_core_012 = 0;
  uint8_t popcount06_jpv8_core_013 = 0;
  uint8_t popcount06_jpv8_core_014 = 0;
  uint8_t popcount06_jpv8_core_015 = 0;
  uint8_t popcount06_jpv8_core_016 = 0;
  uint8_t popcount06_jpv8_core_018 = 0;
  uint8_t popcount06_jpv8_core_019 = 0;
  uint8_t popcount06_jpv8_core_020 = 0;
  uint8_t popcount06_jpv8_core_021 = 0;
  uint8_t popcount06_jpv8_core_022 = 0;
  uint8_t popcount06_jpv8_core_023 = 0;
  uint8_t popcount06_jpv8_core_024 = 0;
  uint8_t popcount06_jpv8_core_025 = 0;
  uint8_t popcount06_jpv8_core_026 = 0;
  uint8_t popcount06_jpv8_core_027_not = 0;
  uint8_t popcount06_jpv8_core_028 = 0;
  uint8_t popcount06_jpv8_core_031_not = 0;
  ...
  popcount06_jpv8_out |= ((popcount06_jpv8_core_020 >> 0) & 0x01ull) << 0;
  popcount06_jpv8_out |= ((popcount06_jpv8_core_024 >> 0) & 0x01ull) << 1;
  popcount06_jpv8_out |= ((popcount06_jpv8_core_026 >> 0) & 0x01ull) << 2;
