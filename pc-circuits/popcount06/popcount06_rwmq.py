...
def popcount06_rwmq(input_a):
  ...
  popcount06_rwmq_out = 0
  popcount06_rwmq_out = (popcount06_rwmq_out) | (((input_a >> 5) & 0x01) << 0)
  popcount06_rwmq_out = (popcount06_rwmq_out) | (((popcount06_rwmq_core_031 >> 0) & 0x01) << 1)
  popcount06_rwmq_out = (popcount06_rwmq_out) | (((input_a >> 0) & 0x01) << 2)
