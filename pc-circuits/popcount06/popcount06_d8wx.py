...
def popcount06_d8wx(input_a):
  ...
  popcount06_d8wx_out = 0
  popcount06_d8wx_out = (popcount06_d8wx_out) | (((popcount06_d8wx_core_011 >> 0) & 0x01) << 0)
  popcount06_d8wx_out = (popcount06_d8wx_out) | (((popcount06_d8wx_core_024 >> 0) & 0x01) << 1)
  popcount06_d8wx_out = (popcount06_d8wx_out) | (((popcount06_d8wx_core_026 >> 0) & 0x01) << 2)
