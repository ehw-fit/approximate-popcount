...
def popcount06_vdxq(input_a):
  ...
  popcount06_vdxq_out = 0
  popcount06_vdxq_out = (popcount06_vdxq_out) | (((popcount06_vdxq_core_010 >> 0) & 0x01) << 0)
  popcount06_vdxq_out = (popcount06_vdxq_out) | (((popcount06_vdxq_core_022 >> 0) & 0x01) << 1)
  popcount06_vdxq_out = (popcount06_vdxq_out) | (((popcount06_vdxq_core_023 >> 0) & 0x01) << 2)
