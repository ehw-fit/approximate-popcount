...
def popcount06_p25c(input_a):
  ...
  popcount06_p25c_out = 0
  popcount06_p25c_out = (popcount06_p25c_out) | ((0x00) << 0)
  popcount06_p25c_out = (popcount06_p25c_out) | (((popcount06_p25c_core_024 >> 0) & 0x01) << 1)
  popcount06_p25c_out = (popcount06_p25c_out) | (((popcount06_p25c_core_026 >> 0) & 0x01) << 2)
