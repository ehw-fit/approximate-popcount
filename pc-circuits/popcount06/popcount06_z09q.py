...
def popcount06_z09q(input_a):
  ...
  popcount06_z09q_out = 0
  popcount06_z09q_out = (popcount06_z09q_out) | (((popcount06_z09q_core_020 >> 0) & 0x01) << 0)
  popcount06_z09q_out = (popcount06_z09q_out) | (((popcount06_z09q_core_024 >> 0) & 0x01) << 1)
  popcount06_z09q_out = (popcount06_z09q_out) | (((popcount06_z09q_core_029 >> 0) & 0x01) << 2)
