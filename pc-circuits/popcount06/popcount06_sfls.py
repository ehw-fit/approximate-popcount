...
def popcount06_sfls(input_a):
  ...
  popcount06_sfls_out = 0
  popcount06_sfls_out = (popcount06_sfls_out) | (((input_a >> 4) & 0x01) << 0)
  popcount06_sfls_out = (popcount06_sfls_out) | (((popcount06_sfls_core_022 >> 0) & 0x01) << 1)
  popcount06_sfls_out = (popcount06_sfls_out) | (((popcount06_sfls_core_023 >> 0) & 0x01) << 2)
