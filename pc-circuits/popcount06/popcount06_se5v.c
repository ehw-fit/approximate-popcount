...
uint64_t popcount06_se5v(uint64_t input_a){
  uint8_t popcount06_se5v_out = 0;
  uint8_t popcount06_se5v_core_008 = 0;
  uint8_t popcount06_se5v_core_009 = 0;
  uint8_t popcount06_se5v_core_010 = 0;
  uint8_t popcount06_se5v_core_011 = 0;
  uint8_t popcount06_se5v_core_012 = 0;
  uint8_t popcount06_se5v_core_013_not = 0;
  uint8_t popcount06_se5v_core_014 = 0;
  uint8_t popcount06_se5v_core_015 = 0;
  uint8_t popcount06_se5v_core_016 = 0;
  uint8_t popcount06_se5v_core_017 = 0;
  uint8_t popcount06_se5v_core_018 = 0;
  uint8_t popcount06_se5v_core_020 = 0;
  uint8_t popcount06_se5v_core_021 = 0;
  uint8_t popcount06_se5v_core_022 = 0;
  uint8_t popcount06_se5v_core_023 = 0;
  uint8_t popcount06_se5v_core_024 = 0;
  uint8_t popcount06_se5v_core_025 = 0;
  uint8_t popcount06_se5v_core_026 = 0;
  ...
  popcount06_se5v_out |= ((popcount06_se5v_core_020 >> 0) & 0x01ull) << 0;
  popcount06_se5v_out |= ((popcount06_se5v_core_024 >> 0) & 0x01ull) << 1;
  popcount06_se5v_out |= ((popcount06_se5v_core_026 >> 0) & 0x01ull) << 2;
