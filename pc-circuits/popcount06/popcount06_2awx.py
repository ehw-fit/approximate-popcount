...
def popcount06_2awx(input_a):
  ...
  popcount06_2awx_out = 0
  popcount06_2awx_out = (popcount06_2awx_out) | (((input_a >> 3) & 0x01) << 0)
  popcount06_2awx_out = (popcount06_2awx_out) | (((popcount06_2awx_core_022 >> 0) & 0x01) << 1)
  popcount06_2awx_out = (popcount06_2awx_out) | (((popcount06_2awx_core_023 >> 0) & 0x01) << 2)
