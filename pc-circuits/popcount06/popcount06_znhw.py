...
def popcount06_znhw(input_a):
  ...
  popcount06_znhw_out = 0
  popcount06_znhw_out = (popcount06_znhw_out) | ((0x01) << 0)
  popcount06_znhw_out = (popcount06_znhw_out) | (((input_a >> 5) & 0x01) << 1)
  popcount06_znhw_out = (popcount06_znhw_out) | ((0x01) << 2)
