...
def popcount06_cm4p(input_a):
  ...
  popcount06_cm4p_out = 0
  popcount06_cm4p_out = (popcount06_cm4p_out) | ((0x00) << 0)
  popcount06_cm4p_out = (popcount06_cm4p_out) | (((popcount06_cm4p_core_024 >> 0) & 0x01) << 1)
  popcount06_cm4p_out = (popcount06_cm4p_out) | (((popcount06_cm4p_core_026 >> 0) & 0x01) << 2)
