...
def popcount06_mjbz(input_a):
  ...
  popcount06_mjbz_out = 0
  popcount06_mjbz_out = (popcount06_mjbz_out) | ((0x01) << 0)
  popcount06_mjbz_out = (popcount06_mjbz_out) | ((0x01) << 1)
  popcount06_mjbz_out = (popcount06_mjbz_out) | ((0x00) << 2)
