...
def popcount06_scxj(input_a):
  ...
  popcount06_scxj_out = 0
  popcount06_scxj_out = (popcount06_scxj_out) | (((input_a >> 2) & 0x01) << 0)
  popcount06_scxj_out = (popcount06_scxj_out) | ((0x01) << 1)
  popcount06_scxj_out = (popcount06_scxj_out) | ((0x01) << 2)
