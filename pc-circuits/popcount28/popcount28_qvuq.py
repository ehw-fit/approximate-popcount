...
def popcount28_qvuq(input_a):
  ...
  popcount28_qvuq_out = 0
  popcount28_qvuq_out = (popcount28_qvuq_out) | (((popcount28_qvuq_core_097 >> 0) & 0x01) << 0)
  popcount28_qvuq_out = (popcount28_qvuq_out) | (((popcount28_qvuq_core_184 >> 0) & 0x01) << 1)
  popcount28_qvuq_out = (popcount28_qvuq_out) | (((popcount28_qvuq_core_189 >> 0) & 0x01) << 2)
  popcount28_qvuq_out = (popcount28_qvuq_out) | (((popcount28_qvuq_core_194 >> 0) & 0x01) << 3)
  popcount28_qvuq_out = (popcount28_qvuq_out) | (((popcount28_qvuq_core_196 >> 0) & 0x01) << 4)
