...
def popcount28_xu2r(input_a):
  ...
  popcount28_xu2r_out = 0
  popcount28_xu2r_out = (popcount28_xu2r_out) | (((popcount28_xu2r_core_180 >> 0) & 0x01) << 0)
  popcount28_xu2r_out = (popcount28_xu2r_out) | (((popcount28_xu2r_core_184 >> 0) & 0x01) << 1)
  popcount28_xu2r_out = (popcount28_xu2r_out) | (((popcount28_xu2r_core_189 >> 0) & 0x01) << 2)
  popcount28_xu2r_out = (popcount28_xu2r_out) | (((popcount28_xu2r_core_194 >> 0) & 0x01) << 3)
  popcount28_xu2r_out = (popcount28_xu2r_out) | (((popcount28_xu2r_core_196 >> 0) & 0x01) << 4)
