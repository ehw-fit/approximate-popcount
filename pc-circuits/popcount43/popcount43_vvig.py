...
def popcount43_vvig(input_a):
  ...
  popcount43_vvig_out = 0
  popcount43_vvig_out = (popcount43_vvig_out) | (((popcount43_vvig_core_314 >> 0) & 0x01) << 0)
  popcount43_vvig_out = (popcount43_vvig_out) | (((popcount43_vvig_core_158 >> 0) & 0x01) << 1)
  popcount43_vvig_out = (popcount43_vvig_out) | (((popcount43_vvig_core_323 >> 0) & 0x01) << 2)
  popcount43_vvig_out = (popcount43_vvig_out) | (((popcount43_vvig_core_328 >> 0) & 0x01) << 3)
  popcount43_vvig_out = (popcount43_vvig_out) | (((popcount43_vvig_core_276 >> 0) & 0x01) << 4)
  popcount43_vvig_out = (popcount43_vvig_out) | (((popcount43_vvig_core_338 >> 0) & 0x01) << 5)
