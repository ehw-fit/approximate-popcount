...
def popcount43_u4y8(input_a):
  ...
  popcount43_u4y8_out = 0
  popcount43_u4y8_out = (popcount43_u4y8_out) | (((popcount43_u4y8_core_314 >> 0) & 0x01) << 0)
  popcount43_u4y8_out = (popcount43_u4y8_out) | (((popcount43_u4y8_core_318 >> 0) & 0x01) << 1)
  popcount43_u4y8_out = (popcount43_u4y8_out) | (((popcount43_u4y8_core_323 >> 0) & 0x01) << 2)
  popcount43_u4y8_out = (popcount43_u4y8_out) | (((popcount43_u4y8_core_328 >> 0) & 0x01) << 3)
  popcount43_u4y8_out = (popcount43_u4y8_out) | (((popcount43_u4y8_core_333 >> 0) & 0x01) << 4)
  popcount43_u4y8_out = (popcount43_u4y8_out) | ((0x00) << 5)
