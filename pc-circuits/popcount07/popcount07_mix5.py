...
def popcount07_mix5(input_a):
  ...
  popcount07_mix5_out = 0
  popcount07_mix5_out = (popcount07_mix5_out) | (((popcount07_mix5_core_026 >> 0) & 0x01) << 0)
  popcount07_mix5_out = (popcount07_mix5_out) | (((popcount07_mix5_core_030 >> 0) & 0x01) << 1)
  popcount07_mix5_out = (popcount07_mix5_out) | (((popcount07_mix5_core_032 >> 0) & 0x01) << 2)
