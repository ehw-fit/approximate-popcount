...
def popcount07_k9pv(input_a):
  ...
  popcount07_k9pv_out = 0
  popcount07_k9pv_out = (popcount07_k9pv_out) | (((popcount07_k9pv_core_026 >> 0) & 0x01) << 0)
  popcount07_k9pv_out = (popcount07_k9pv_out) | (((popcount07_k9pv_core_030 >> 0) & 0x01) << 1)
  popcount07_k9pv_out = (popcount07_k9pv_out) | (((popcount07_k9pv_core_032 >> 0) & 0x01) << 2)
