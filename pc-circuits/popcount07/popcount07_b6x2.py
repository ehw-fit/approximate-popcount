...
def popcount07_b6x2(input_a):
  ...
  popcount07_b6x2_out = 0
  popcount07_b6x2_out = (popcount07_b6x2_out) | (((popcount07_b6x2_core_016 >> 0) & 0x01) << 0)
  popcount07_b6x2_out = (popcount07_b6x2_out) | (((popcount07_b6x2_core_028 >> 0) & 0x01) << 1)
  popcount07_b6x2_out = (popcount07_b6x2_out) | (((popcount07_b6x2_core_035 >> 0) & 0x01) << 2)
