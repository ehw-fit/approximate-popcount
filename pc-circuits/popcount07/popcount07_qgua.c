...
uint64_t popcount07_qgua(uint64_t input_a){
  uint8_t popcount07_qgua_out = 0;
  uint8_t popcount07_qgua_core_009 = 0;
  uint8_t popcount07_qgua_core_010 = 0;
  uint8_t popcount07_qgua_core_011 = 0;
  uint8_t popcount07_qgua_core_012 = 0;
  uint8_t popcount07_qgua_core_013 = 0;
  uint8_t popcount07_qgua_core_015 = 0;
  uint8_t popcount07_qgua_core_016 = 0;
  uint8_t popcount07_qgua_core_017 = 0;
  uint8_t popcount07_qgua_core_018 = 0;
  uint8_t popcount07_qgua_core_019 = 0;
  uint8_t popcount07_qgua_core_021 = 0;
  uint8_t popcount07_qgua_core_022 = 0;
  uint8_t popcount07_qgua_core_026 = 0;
  uint8_t popcount07_qgua_core_027 = 0;
  uint8_t popcount07_qgua_core_028 = 0;
  uint8_t popcount07_qgua_core_029 = 0;
  uint8_t popcount07_qgua_core_030 = 0;
  uint8_t popcount07_qgua_core_031 = 0;
  uint8_t popcount07_qgua_core_032 = 0;
  uint8_t popcount07_qgua_core_035 = 0;
  uint8_t popcount07_qgua_core_037 = 0;
  ...
  popcount07_qgua_out |= ((input_a[3] >> 0) & 0x01ull) << 0;
  popcount07_qgua_out |= ((popcount07_qgua_core_030 >> 0) & 0x01ull) << 1;
  popcount07_qgua_out |= ((popcount07_qgua_core_035 >> 0) & 0x01ull) << 2;
