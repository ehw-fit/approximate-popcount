...
uint64_t popcount07_ywb9(uint64_t input_a){
  uint8_t popcount07_ywb9_out = 0;
  uint8_t popcount07_ywb9_core_009 = 0;
  uint8_t popcount07_ywb9_core_010 = 0;
  uint8_t popcount07_ywb9_core_011 = 0;
  uint8_t popcount07_ywb9_core_012_not = 0;
  uint8_t popcount07_ywb9_core_013 = 0;
  uint8_t popcount07_ywb9_core_015 = 0;
  uint8_t popcount07_ywb9_core_016 = 0;
  uint8_t popcount07_ywb9_core_017 = 0;
  uint8_t popcount07_ywb9_core_018 = 0;
  uint8_t popcount07_ywb9_core_020 = 0;
  uint8_t popcount07_ywb9_core_021 = 0;
  uint8_t popcount07_ywb9_core_022 = 0;
  uint8_t popcount07_ywb9_core_023 = 0;
  uint8_t popcount07_ywb9_core_024 = 0;
  uint8_t popcount07_ywb9_core_026 = 0;
  uint8_t popcount07_ywb9_core_028 = 0;
  uint8_t popcount07_ywb9_core_029 = 0;
  uint8_t popcount07_ywb9_core_031 = 0;
  uint8_t popcount07_ywb9_core_035 = 0;
  uint8_t popcount07_ywb9_core_037 = 0;
  ...
  popcount07_ywb9_out |= ((popcount07_ywb9_core_026 >> 0) & 0x01ull) << 0;
  popcount07_ywb9_out |= ((popcount07_ywb9_core_011 >> 0) & 0x01ull) << 1;
  popcount07_ywb9_out |= ((popcount07_ywb9_core_035 >> 0) & 0x01ull) << 2;
