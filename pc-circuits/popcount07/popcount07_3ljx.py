...
def popcount07_3ljx(input_a):
  ...
  popcount07_3ljx_out = 0
  popcount07_3ljx_out = (popcount07_3ljx_out) | ((0x00) << 0)
  popcount07_3ljx_out = (popcount07_3ljx_out) | ((0x01) << 1)
  popcount07_3ljx_out = (popcount07_3ljx_out) | ((0x00) << 2)
