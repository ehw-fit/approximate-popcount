...
def popcount07_nscg(input_a):
  ...
  popcount07_nscg_out = 0
  popcount07_nscg_out = (popcount07_nscg_out) | (((input_a >> 0) & 0x01) << 0)
  popcount07_nscg_out = (popcount07_nscg_out) | ((0x01) << 1)
  popcount07_nscg_out = (popcount07_nscg_out) | ((0x00) << 2)
