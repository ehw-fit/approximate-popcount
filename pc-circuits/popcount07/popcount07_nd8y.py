...
def popcount07_nd8y(input_a):
  ...
  popcount07_nd8y_out = 0
  popcount07_nd8y_out = (popcount07_nd8y_out) | (((input_a >> 6) & 0x01) << 0)
  popcount07_nd8y_out = (popcount07_nd8y_out) | (((popcount07_nd8y_core_028 >> 0) & 0x01) << 1)
  popcount07_nd8y_out = (popcount07_nd8y_out) | (((popcount07_nd8y_core_013 >> 0) & 0x01) << 2)
