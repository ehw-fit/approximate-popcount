...
uint64_t popcount07_nn4c(uint64_t input_a){
  uint8_t popcount07_nn4c_out = 0;
  uint8_t popcount07_nn4c_core_009 = 0;
  uint8_t popcount07_nn4c_core_010 = 0;
  uint8_t popcount07_nn4c_core_011 = 0;
  uint8_t popcount07_nn4c_core_012 = 0;
  uint8_t popcount07_nn4c_core_013 = 0;
  uint8_t popcount07_nn4c_core_014 = 0;
  uint8_t popcount07_nn4c_core_015 = 0;
  uint8_t popcount07_nn4c_core_016 = 0;
  uint8_t popcount07_nn4c_core_017 = 0;
  uint8_t popcount07_nn4c_core_020 = 0;
  uint8_t popcount07_nn4c_core_021 = 0;
  uint8_t popcount07_nn4c_core_022 = 0;
  uint8_t popcount07_nn4c_core_024 = 0;
  uint8_t popcount07_nn4c_core_026_not = 0;
  uint8_t popcount07_nn4c_core_028 = 0;
  uint8_t popcount07_nn4c_core_029 = 0;
  uint8_t popcount07_nn4c_core_030 = 0;
  uint8_t popcount07_nn4c_core_031 = 0;
  uint8_t popcount07_nn4c_core_032 = 0;
  uint8_t popcount07_nn4c_core_033 = 0;
  uint8_t popcount07_nn4c_core_034 = 0;
  uint8_t popcount07_nn4c_core_035_not = 0;
  uint8_t popcount07_nn4c_core_037 = 0;
  ...
  popcount07_nn4c_out |= ((input_a[6] >> 0) & 0x01ull) << 0;
  popcount07_nn4c_out |= ((popcount07_nn4c_core_030 >> 0) & 0x01ull) << 1;
  popcount07_nn4c_out |= ((popcount07_nn4c_core_032 >> 0) & 0x01ull) << 2;
