...
def popcount07_zxuq(input_a):
  ...
  popcount07_zxuq_out = 0
  popcount07_zxuq_out = (popcount07_zxuq_out) | (((popcount07_zxuq_core_022 >> 0) & 0x01) << 0)
  popcount07_zxuq_out = (popcount07_zxuq_out) | (((popcount07_zxuq_core_030 >> 0) & 0x01) << 1)
  popcount07_zxuq_out = (popcount07_zxuq_out) | (((popcount07_zxuq_core_035 >> 0) & 0x01) << 2)
