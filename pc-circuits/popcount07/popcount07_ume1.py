...
def popcount07_ume1(input_a):
  ...
  popcount07_ume1_out = 0
  popcount07_ume1_out = (popcount07_ume1_out) | (((input_a >> 3) & 0x01) << 0)
  popcount07_ume1_out = (popcount07_ume1_out) | (((popcount07_ume1_core_030 >> 0) & 0x01) << 1)
  popcount07_ume1_out = (popcount07_ume1_out) | (((popcount07_ume1_core_035 >> 0) & 0x01) << 2)
