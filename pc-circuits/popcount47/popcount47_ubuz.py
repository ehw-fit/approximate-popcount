...
def popcount47_ubuz(input_a):
  ...
  popcount47_ubuz_out = 0
  popcount47_ubuz_out = (popcount47_ubuz_out) | (((input_a >> 38) & 0x01) << 0)
  popcount47_ubuz_out = (popcount47_ubuz_out) | (((popcount47_ubuz_core_350 >> 0) & 0x01) << 1)
  popcount47_ubuz_out = (popcount47_ubuz_out) | (((popcount47_ubuz_core_355 >> 0) & 0x01) << 2)
  popcount47_ubuz_out = (popcount47_ubuz_out) | (((popcount47_ubuz_core_360 >> 0) & 0x01) << 3)
  popcount47_ubuz_out = (popcount47_ubuz_out) | (((popcount47_ubuz_core_365 >> 0) & 0x01) << 4)
  popcount47_ubuz_out = (popcount47_ubuz_out) | (((popcount47_ubuz_core_367 >> 0) & 0x01) << 5)
