...
def popcount47_leqn(input_a):
  ...
  popcount47_leqn_out = 0
  popcount47_leqn_out = (popcount47_leqn_out) | (((popcount47_leqn_core_346_not >> 0) & 0x01) << 0)
  popcount47_leqn_out = (popcount47_leqn_out) | (((popcount47_leqn_core_350 >> 0) & 0x01) << 1)
  popcount47_leqn_out = (popcount47_leqn_out) | (((popcount47_leqn_core_355 >> 0) & 0x01) << 2)
  popcount47_leqn_out = (popcount47_leqn_out) | (((popcount47_leqn_core_360 >> 0) & 0x01) << 3)
  popcount47_leqn_out = (popcount47_leqn_out) | (((popcount47_leqn_core_365 >> 0) & 0x01) << 4)
  popcount47_leqn_out = (popcount47_leqn_out) | (((popcount47_leqn_core_367 >> 0) & 0x01) << 5)
