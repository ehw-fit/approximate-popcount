...
def popcount47_eh0n(input_a):
  ...
  popcount47_eh0n_out = 0
  popcount47_eh0n_out = (popcount47_eh0n_out) | (((popcount47_eh0n_core_346 >> 0) & 0x01) << 0)
  popcount47_eh0n_out = (popcount47_eh0n_out) | (((popcount47_eh0n_core_350 >> 0) & 0x01) << 1)
  popcount47_eh0n_out = (popcount47_eh0n_out) | (((popcount47_eh0n_core_355 >> 0) & 0x01) << 2)
  popcount47_eh0n_out = (popcount47_eh0n_out) | (((popcount47_eh0n_core_360 >> 0) & 0x01) << 3)
  popcount47_eh0n_out = (popcount47_eh0n_out) | (((popcount47_eh0n_core_365 >> 0) & 0x01) << 4)
  popcount47_eh0n_out = (popcount47_eh0n_out) | (((popcount47_eh0n_core_366 >> 0) & 0x01) << 5)
