...
def popcount03_w7cr(input_a):
  ...
  popcount03_w7cr_out = 0
  popcount03_w7cr_out = (popcount03_w7cr_out) | (((popcount03_w7cr_core_007 >> 0) & 0x01) << 0)
  popcount03_w7cr_out = (popcount03_w7cr_out) | (((popcount03_w7cr_core_009 >> 0) & 0x01) << 1)
