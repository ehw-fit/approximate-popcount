...
def popcount03_ybfi(input_a):
  ...
  popcount03_ybfi_out = 0
  popcount03_ybfi_out = (popcount03_ybfi_out) | (((input_a >> 1) & 0x01) << 0)
  popcount03_ybfi_out = (popcount03_ybfi_out) | ((0x01) << 1)
