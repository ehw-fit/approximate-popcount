...
def popcount30_uea4(input_a):
  ...
  popcount30_uea4_out = 0
  popcount30_uea4_out = (popcount30_uea4_out) | (((input_a >> 20) & 0x01) << 0)
  popcount30_uea4_out = (popcount30_uea4_out) | (((input_a >> 29) & 0x01) << 1)
  popcount30_uea4_out = (popcount30_uea4_out) | (((popcount30_uea4_core_201 >> 0) & 0x01) << 2)
  popcount30_uea4_out = (popcount30_uea4_out) | (((popcount30_uea4_core_201 >> 0) & 0x01) << 3)
  popcount30_uea4_out = (popcount30_uea4_out) | (((popcount30_uea4_core_045 >> 0) & 0x01) << 4)
