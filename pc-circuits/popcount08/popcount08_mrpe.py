...
def popcount08_mrpe(input_a):
  ...
  popcount08_mrpe_out = 0
  popcount08_mrpe_out = (popcount08_mrpe_out) | (((input_a >> 1) & 0x01) << 0)
  popcount08_mrpe_out = (popcount08_mrpe_out) | (((popcount08_mrpe_core_034 >> 0) & 0x01) << 1)
  popcount08_mrpe_out = (popcount08_mrpe_out) | (((popcount08_mrpe_core_041 >> 0) & 0x01) << 2)
  popcount08_mrpe_out = (popcount08_mrpe_out) | (((popcount08_mrpe_core_040 >> 0) & 0x01) << 3)
