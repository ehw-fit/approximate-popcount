...
uint64_t popcount08_e7rz(uint64_t input_a){
  uint8_t popcount08_e7rz_out = 0;
  uint8_t popcount08_e7rz_core_010 = 0;
  uint8_t popcount08_e7rz_core_011 = 0;
  uint8_t popcount08_e7rz_core_012 = 0;
  uint8_t popcount08_e7rz_core_013 = 0;
  uint8_t popcount08_e7rz_core_014 = 0;
  uint8_t popcount08_e7rz_core_015 = 0;
  uint8_t popcount08_e7rz_core_016 = 0;
  uint8_t popcount08_e7rz_core_017 = 0;
  uint8_t popcount08_e7rz_core_018 = 0;
  uint8_t popcount08_e7rz_core_019 = 0;
  uint8_t popcount08_e7rz_core_023 = 0;
  uint8_t popcount08_e7rz_core_024 = 0;
  uint8_t popcount08_e7rz_core_027 = 0;
  uint8_t popcount08_e7rz_core_028 = 0;
  uint8_t popcount08_e7rz_core_029 = 0;
  uint8_t popcount08_e7rz_core_032 = 0;
  uint8_t popcount08_e7rz_core_033 = 0;
  uint8_t popcount08_e7rz_core_034 = 0;
  uint8_t popcount08_e7rz_core_035 = 0;
  uint8_t popcount08_e7rz_core_039 = 0;
  uint8_t popcount08_e7rz_core_040 = 0;
  uint8_t popcount08_e7rz_core_041 = 0;
  ...
  popcount08_e7rz_out |= ((input_a[4] >> 0) & 0x01ull) << 0;
  popcount08_e7rz_out |= ((popcount08_e7rz_core_034 >> 0) & 0x01ull) << 1;
  popcount08_e7rz_out |= ((popcount08_e7rz_core_041 >> 0) & 0x01ull) << 2;
  popcount08_e7rz_out |= ((popcount08_e7rz_core_040 >> 0) & 0x01ull) << 3;
