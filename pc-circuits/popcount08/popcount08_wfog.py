...
def popcount08_wfog(input_a):
  ...
  popcount08_wfog_out = 0
  popcount08_wfog_out = (popcount08_wfog_out) | (((popcount08_wfog_core_032 >> 0) & 0x01) << 0)
  popcount08_wfog_out = (popcount08_wfog_out) | (((popcount08_wfog_core_036 >> 0) & 0x01) << 1)
  popcount08_wfog_out = (popcount08_wfog_out) | (((popcount08_wfog_core_041 >> 0) & 0x01) << 2)
  popcount08_wfog_out = (popcount08_wfog_out) | ((0x00) << 3)
