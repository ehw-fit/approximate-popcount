...
uint64_t popcount08_syyz(uint64_t input_a){
  uint8_t popcount08_syyz_out = 0;
  uint8_t popcount08_syyz_core_010 = 0;
  uint8_t popcount08_syyz_core_011 = 0;
  uint8_t popcount08_syyz_core_012 = 0;
  uint8_t popcount08_syyz_core_013 = 0;
  uint8_t popcount08_syyz_core_016 = 0;
  uint8_t popcount08_syyz_core_017 = 0;
  uint8_t popcount08_syyz_core_021 = 0;
  uint8_t popcount08_syyz_core_022 = 0;
  uint8_t popcount08_syyz_core_023 = 0;
  uint8_t popcount08_syyz_core_024 = 0;
  uint8_t popcount08_syyz_core_025 = 0;
  uint8_t popcount08_syyz_core_026 = 0;
  uint8_t popcount08_syyz_core_027 = 0;
  uint8_t popcount08_syyz_core_028 = 0;
  uint8_t popcount08_syyz_core_029 = 0;
  uint8_t popcount08_syyz_core_032 = 0;
  uint8_t popcount08_syyz_core_034 = 0;
  uint8_t popcount08_syyz_core_035 = 0;
  uint8_t popcount08_syyz_core_036 = 0;
  uint8_t popcount08_syyz_core_037 = 0;
  uint8_t popcount08_syyz_core_038 = 0;
  uint8_t popcount08_syyz_core_039 = 0;
  uint8_t popcount08_syyz_core_040 = 0;
  uint8_t popcount08_syyz_core_041 = 0;
  uint8_t popcount08_syyz_core_042 = 0;
  uint8_t popcount08_syyz_core_043 = 0;
  ...
  popcount08_syyz_out |= ((popcount08_syyz_core_012 >> 0) & 0x01ull) << 0;
  popcount08_syyz_out |= ((popcount08_syyz_core_036 >> 0) & 0x01ull) << 1;
  popcount08_syyz_out |= ((popcount08_syyz_core_041 >> 0) & 0x01ull) << 2;
  popcount08_syyz_out |= ((popcount08_syyz_core_043 >> 0) & 0x01ull) << 3;
