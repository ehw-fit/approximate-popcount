...
uint64_t popcount08_rjet(uint64_t input_a){
  uint8_t popcount08_rjet_out = 0;
  uint8_t popcount08_rjet_core_010 = 0;
  uint8_t popcount08_rjet_core_011 = 0;
  uint8_t popcount08_rjet_core_012 = 0;
  uint8_t popcount08_rjet_core_013 = 0;
  uint8_t popcount08_rjet_core_014 = 0;
  uint8_t popcount08_rjet_core_015 = 0;
  uint8_t popcount08_rjet_core_016 = 0;
  uint8_t popcount08_rjet_core_017 = 0;
  uint8_t popcount08_rjet_core_018 = 0;
  uint8_t popcount08_rjet_core_019 = 0;
  uint8_t popcount08_rjet_core_021 = 0;
  uint8_t popcount08_rjet_core_022 = 0;
  uint8_t popcount08_rjet_core_023 = 0;
  uint8_t popcount08_rjet_core_024 = 0;
  uint8_t popcount08_rjet_core_025 = 0;
  uint8_t popcount08_rjet_core_026 = 0;
  uint8_t popcount08_rjet_core_027 = 0;
  uint8_t popcount08_rjet_core_028 = 0;
  uint8_t popcount08_rjet_core_029 = 0;
  uint8_t popcount08_rjet_core_030 = 0;
  uint8_t popcount08_rjet_core_032 = 0;
  uint8_t popcount08_rjet_core_033 = 0;
  uint8_t popcount08_rjet_core_034 = 0;
  uint8_t popcount08_rjet_core_035 = 0;
  uint8_t popcount08_rjet_core_036 = 0;
  uint8_t popcount08_rjet_core_037 = 0;
  uint8_t popcount08_rjet_core_038 = 0;
  uint8_t popcount08_rjet_core_039 = 0;
  uint8_t popcount08_rjet_core_040 = 0;
  uint8_t popcount08_rjet_core_041 = 0;
  uint8_t popcount08_rjet_core_042 = 0;
  ...
  popcount08_rjet_out |= ((popcount08_rjet_core_032 >> 0) & 0x01ull) << 0;
  popcount08_rjet_out |= ((popcount08_rjet_core_036 >> 0) & 0x01ull) << 1;
  popcount08_rjet_out |= ((popcount08_rjet_core_041 >> 0) & 0x01ull) << 2;
  popcount08_rjet_out |= ((popcount08_rjet_core_040 >> 0) & 0x01ull) << 3;
