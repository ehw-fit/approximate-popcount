...
uint64_t popcount08_sosq(uint64_t input_a){
  uint8_t popcount08_sosq_out = 0;
  uint8_t popcount08_sosq_core_012 = 0;
  uint8_t popcount08_sosq_core_013 = 0;
  uint8_t popcount08_sosq_core_018 = 0;
  uint8_t popcount08_sosq_core_019 = 0;
  uint8_t popcount08_sosq_core_020 = 0;
  uint8_t popcount08_sosq_core_021 = 0;
  uint8_t popcount08_sosq_core_024 = 0;
  uint8_t popcount08_sosq_core_025 = 0;
  uint8_t popcount08_sosq_core_026 = 0;
  uint8_t popcount08_sosq_core_028 = 0;
  uint8_t popcount08_sosq_core_030 = 0;
  uint8_t popcount08_sosq_core_032 = 0;
  uint8_t popcount08_sosq_core_034 = 0;
  uint8_t popcount08_sosq_core_035 = 0;
  uint8_t popcount08_sosq_core_036 = 0;
  uint8_t popcount08_sosq_core_038 = 0;
  uint8_t popcount08_sosq_core_041 = 0;
  ...
  popcount08_sosq_out |= (0x00) << 0;
  popcount08_sosq_out |= (0x01) << 1;
  popcount08_sosq_out |= (0x01) << 2;
  popcount08_sosq_out |= (0x00) << 3;
