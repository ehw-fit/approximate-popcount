...
def popcount08_5jvn(input_a):
  ...
  popcount08_5jvn_out = 0
  popcount08_5jvn_out = (popcount08_5jvn_out) | ((0x00) << 0)
  popcount08_5jvn_out = (popcount08_5jvn_out) | (((input_a >> 4) & 0x01) << 1)
  popcount08_5jvn_out = (popcount08_5jvn_out) | ((0x01) << 2)
  popcount08_5jvn_out = (popcount08_5jvn_out) | ((0x00) << 3)
