...
def popcount08_yzvu(input_a):
  ...
  popcount08_yzvu_out = 0
  popcount08_yzvu_out = (popcount08_yzvu_out) | (((popcount08_yzvu_core_032 >> 0) & 0x01) << 0)
  popcount08_yzvu_out = (popcount08_yzvu_out) | (((popcount08_yzvu_core_036 >> 0) & 0x01) << 1)
  popcount08_yzvu_out = (popcount08_yzvu_out) | (((popcount08_yzvu_core_041 >> 0) & 0x01) << 2)
  popcount08_yzvu_out = (popcount08_yzvu_out) | ((0x00) << 3)
