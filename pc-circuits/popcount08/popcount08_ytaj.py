...
def popcount08_ytaj(input_a):
  ...
  popcount08_ytaj_out = 0
  popcount08_ytaj_out = (popcount08_ytaj_out) | (((input_a >> 1) & 0x01) << 0)
  popcount08_ytaj_out = (popcount08_ytaj_out) | ((0x01) << 1)
  popcount08_ytaj_out = (popcount08_ytaj_out) | ((0x00) << 2)
  popcount08_ytaj_out = (popcount08_ytaj_out) | ((0x00) << 3)
