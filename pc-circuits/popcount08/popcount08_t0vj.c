...
uint64_t popcount08_t0vj(uint64_t input_a){
  uint8_t popcount08_t0vj_out = 0;
  uint8_t popcount08_t0vj_core_011 = 0;
  uint8_t popcount08_t0vj_core_014 = 0;
  uint8_t popcount08_t0vj_core_015 = 0;
  uint8_t popcount08_t0vj_core_017 = 0;
  uint8_t popcount08_t0vj_core_021 = 0;
  uint8_t popcount08_t0vj_core_022 = 0;
  uint8_t popcount08_t0vj_core_023 = 0;
  uint8_t popcount08_t0vj_core_024 = 0;
  uint8_t popcount08_t0vj_core_025 = 0;
  uint8_t popcount08_t0vj_core_026 = 0;
  uint8_t popcount08_t0vj_core_027 = 0;
  uint8_t popcount08_t0vj_core_028 = 0;
  uint8_t popcount08_t0vj_core_029 = 0;
  uint8_t popcount08_t0vj_core_032 = 0;
  uint8_t popcount08_t0vj_core_033 = 0;
  uint8_t popcount08_t0vj_core_036 = 0;
  uint8_t popcount08_t0vj_core_037 = 0;
  uint8_t popcount08_t0vj_core_039 = 0;
  uint8_t popcount08_t0vj_core_040 = 0;
  uint8_t popcount08_t0vj_core_041 = 0;
  uint8_t popcount08_t0vj_core_042 = 0;
  uint8_t popcount08_t0vj_core_043 = 0;
  ...
  popcount08_t0vj_out |= ((popcount08_t0vj_core_015 >> 0) & 0x01ull) << 0;
  popcount08_t0vj_out |= ((popcount08_t0vj_core_036 >> 0) & 0x01ull) << 1;
  popcount08_t0vj_out |= ((popcount08_t0vj_core_041 >> 0) & 0x01ull) << 2;
  popcount08_t0vj_out |= ((popcount08_t0vj_core_043 >> 0) & 0x01ull) << 3;
