...
uint64_t popcount08_oitm(uint64_t input_a){
  uint8_t popcount08_oitm_out = 0;
  uint8_t popcount08_oitm_core_010 = 0;
  uint8_t popcount08_oitm_core_012 = 0;
  uint8_t popcount08_oitm_core_013 = 0;
  uint8_t popcount08_oitm_core_014 = 0;
  uint8_t popcount08_oitm_core_015 = 0;
  uint8_t popcount08_oitm_core_017 = 0;
  uint8_t popcount08_oitm_core_018 = 0;
  uint8_t popcount08_oitm_core_020 = 0;
  uint8_t popcount08_oitm_core_024 = 0;
  uint8_t popcount08_oitm_core_026 = 0;
  uint8_t popcount08_oitm_core_028 = 0;
  uint8_t popcount08_oitm_core_030_not = 0;
  uint8_t popcount08_oitm_core_036 = 0;
  uint8_t popcount08_oitm_core_040 = 0;
  uint8_t popcount08_oitm_core_043 = 0;
  ...
  popcount08_oitm_out |= (0x00) << 0;
  popcount08_oitm_out |= (0x00) << 1;
  popcount08_oitm_out |= (0x01) << 2;
  popcount08_oitm_out |= (0x00) << 3;
