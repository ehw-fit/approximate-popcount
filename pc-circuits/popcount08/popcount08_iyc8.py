...
def popcount08_iyc8(input_a):
  ...
  popcount08_iyc8_out = 0
  popcount08_iyc8_out = (popcount08_iyc8_out) | (((popcount08_iyc8_core_032 >> 0) & 0x01) << 0)
  popcount08_iyc8_out = (popcount08_iyc8_out) | (((popcount08_iyc8_core_036 >> 0) & 0x01) << 1)
  popcount08_iyc8_out = (popcount08_iyc8_out) | (((popcount08_iyc8_core_038 >> 0) & 0x01) << 2)
  popcount08_iyc8_out = (popcount08_iyc8_out) | ((0x00) << 3)
