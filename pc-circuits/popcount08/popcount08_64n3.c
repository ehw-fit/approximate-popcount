...
uint64_t popcount08_64n3(uint64_t input_a){
  uint8_t popcount08_64n3_out = 0;
  uint8_t popcount08_64n3_core_010_not = 0;
  uint8_t popcount08_64n3_core_011 = 0;
  uint8_t popcount08_64n3_core_012 = 0;
  uint8_t popcount08_64n3_core_013 = 0;
  uint8_t popcount08_64n3_core_014 = 0;
  uint8_t popcount08_64n3_core_015 = 0;
  uint8_t popcount08_64n3_core_017 = 0;
  uint8_t popcount08_64n3_core_019 = 0;
  uint8_t popcount08_64n3_core_020 = 0;
  uint8_t popcount08_64n3_core_021 = 0;
  uint8_t popcount08_64n3_core_022 = 0;
  uint8_t popcount08_64n3_core_024 = 0;
  uint8_t popcount08_64n3_core_027 = 0;
  uint8_t popcount08_64n3_core_028 = 0;
  uint8_t popcount08_64n3_core_030 = 0;
  uint8_t popcount08_64n3_core_031 = 0;
  uint8_t popcount08_64n3_core_032 = 0;
  uint8_t popcount08_64n3_core_034 = 0;
  uint8_t popcount08_64n3_core_036 = 0;
  uint8_t popcount08_64n3_core_038 = 0;
  uint8_t popcount08_64n3_core_039 = 0;
  uint8_t popcount08_64n3_core_043 = 0;
  ...
  popcount08_64n3_out |= ((input_a[2] >> 0) & 0x01ull) << 0;
  popcount08_64n3_out |= ((popcount08_64n3_core_036 >> 0) & 0x01ull) << 1;
  popcount08_64n3_out |= ((popcount08_64n3_core_038 >> 0) & 0x01ull) << 2;
  popcount08_64n3_out |= (0x00) << 3;
