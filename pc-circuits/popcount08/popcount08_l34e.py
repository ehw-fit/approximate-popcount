...
def popcount08_l34e(input_a):
  ...
  popcount08_l34e_out = 0
  popcount08_l34e_out = (popcount08_l34e_out) | (((input_a >> 6) & 0x01) << 0)
  popcount08_l34e_out = (popcount08_l34e_out) | (((popcount08_l34e_core_034 >> 0) & 0x01) << 1)
  popcount08_l34e_out = (popcount08_l34e_out) | (((popcount08_l34e_core_041 >> 0) & 0x01) << 2)
  popcount08_l34e_out = (popcount08_l34e_out) | ((0x00) << 3)
