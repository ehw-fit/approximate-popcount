...
def popcount22_tvkn(input_a):
  ...
  popcount22_tvkn_out = 0
  popcount22_tvkn_out = (popcount22_tvkn_out) | (((input_a >> 12) & 0x01) << 0)
  popcount22_tvkn_out = (popcount22_tvkn_out) | (((popcount22_tvkn_core_144 >> 0) & 0x01) << 1)
  popcount22_tvkn_out = (popcount22_tvkn_out) | (((popcount22_tvkn_core_149 >> 0) & 0x01) << 2)
  popcount22_tvkn_out = (popcount22_tvkn_out) | (((popcount22_tvkn_core_154 >> 0) & 0x01) << 3)
  popcount22_tvkn_out = (popcount22_tvkn_out) | (((popcount22_tvkn_core_156 >> 0) & 0x01) << 4)
