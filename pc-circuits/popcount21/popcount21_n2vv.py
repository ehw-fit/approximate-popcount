...
def popcount21_n2vv(input_a):
  ...
  popcount21_n2vv_out = 0
  popcount21_n2vv_out = (popcount21_n2vv_out) | (((popcount21_n2vv_core_132 >> 0) & 0x01) << 0)
  popcount21_n2vv_out = (popcount21_n2vv_out) | (((popcount21_n2vv_core_136 >> 0) & 0x01) << 1)
  popcount21_n2vv_out = (popcount21_n2vv_out) | (((popcount21_n2vv_core_141 >> 0) & 0x01) << 2)
  popcount21_n2vv_out = (popcount21_n2vv_out) | (((popcount21_n2vv_core_146 >> 0) & 0x01) << 3)
  popcount21_n2vv_out = (popcount21_n2vv_out) | (((popcount21_n2vv_core_148 >> 0) & 0x01) << 4)
