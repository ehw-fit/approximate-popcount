...
def popcount40_ruo9(input_a):
  ...
  popcount40_ruo9_out = 0
  popcount40_ruo9_out = (popcount40_ruo9_out) | (((input_a >> 8) & 0x01) << 0)
  popcount40_ruo9_out = (popcount40_ruo9_out) | (((popcount40_ruo9_core_294 >> 0) & 0x01) << 1)
  popcount40_ruo9_out = (popcount40_ruo9_out) | (((popcount40_ruo9_core_299 >> 0) & 0x01) << 2)
  popcount40_ruo9_out = (popcount40_ruo9_out) | (((popcount40_ruo9_core_304 >> 0) & 0x01) << 3)
  popcount40_ruo9_out = (popcount40_ruo9_out) | (((popcount40_ruo9_core_309 >> 0) & 0x01) << 4)
  popcount40_ruo9_out = (popcount40_ruo9_out) | (((popcount40_ruo9_core_311 >> 0) & 0x01) << 5)
