...
def popcount40_jzqs(input_a):
  ...
  popcount40_jzqs_out = 0
  popcount40_jzqs_out = (popcount40_jzqs_out) | (((popcount40_jzqs_core_290 >> 0) & 0x01) << 0)
  popcount40_jzqs_out = (popcount40_jzqs_out) | (((popcount40_jzqs_core_294 >> 0) & 0x01) << 1)
  popcount40_jzqs_out = (popcount40_jzqs_out) | (((popcount40_jzqs_core_299 >> 0) & 0x01) << 2)
  popcount40_jzqs_out = (popcount40_jzqs_out) | (((popcount40_jzqs_core_304 >> 0) & 0x01) << 3)
  popcount40_jzqs_out = (popcount40_jzqs_out) | (((popcount40_jzqs_core_306 >> 0) & 0x01) << 4)
  popcount40_jzqs_out = (popcount40_jzqs_out) | ((0x00) << 5)
