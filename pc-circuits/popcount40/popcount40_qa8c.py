...
def popcount40_qa8c(input_a):
  ...
  popcount40_qa8c_out = 0
  popcount40_qa8c_out = (popcount40_qa8c_out) | (((input_a >> 3) & 0x01) << 0)
  popcount40_qa8c_out = (popcount40_qa8c_out) | (((popcount40_qa8c_core_294 >> 0) & 0x01) << 1)
  popcount40_qa8c_out = (popcount40_qa8c_out) | (((popcount40_qa8c_core_299 >> 0) & 0x01) << 2)
  popcount40_qa8c_out = (popcount40_qa8c_out) | (((popcount40_qa8c_core_304 >> 0) & 0x01) << 3)
  popcount40_qa8c_out = (popcount40_qa8c_out) | (((popcount40_qa8c_core_309 >> 0) & 0x01) << 4)
  popcount40_qa8c_out = (popcount40_qa8c_out) | (((popcount40_qa8c_core_311 >> 0) & 0x01) << 5)
