...
def popcount31_e1p5(input_a):
  ...
  popcount31_e1p5_out = 0
  popcount31_e1p5_out = (popcount31_e1p5_out) | (((input_a >> 14) & 0x01) << 0)
  popcount31_e1p5_out = (popcount31_e1p5_out) | (((popcount31_e1p5_core_202 >> 0) & 0x01) << 1)
  popcount31_e1p5_out = (popcount31_e1p5_out) | (((popcount31_e1p5_core_207 >> 0) & 0x01) << 2)
  popcount31_e1p5_out = (popcount31_e1p5_out) | (((popcount31_e1p5_core_212 >> 0) & 0x01) << 3)
  popcount31_e1p5_out = (popcount31_e1p5_out) | (((popcount31_e1p5_core_217 >> 0) & 0x01) << 4)
