...
def popcount39_n9ae(input_a):
  ...
  popcount39_n9ae_out = 0
  popcount39_n9ae_out = (popcount39_n9ae_out) | (((popcount39_n9ae_core_280 >> 0) & 0x01) << 0)
  popcount39_n9ae_out = (popcount39_n9ae_out) | (((popcount39_n9ae_core_284 >> 0) & 0x01) << 1)
  popcount39_n9ae_out = (popcount39_n9ae_out) | (((popcount39_n9ae_core_289 >> 0) & 0x01) << 2)
  popcount39_n9ae_out = (popcount39_n9ae_out) | (((popcount39_n9ae_core_294 >> 0) & 0x01) << 3)
  popcount39_n9ae_out = (popcount39_n9ae_out) | (((popcount39_n9ae_core_299 >> 0) & 0x01) << 4)
  popcount39_n9ae_out = (popcount39_n9ae_out) | (((popcount39_n9ae_core_301 >> 0) & 0x01) << 5)
