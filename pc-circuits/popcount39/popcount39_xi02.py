...
def popcount39_xi02(input_a):
  ...
  popcount39_xi02_out = 0
  popcount39_xi02_out = (popcount39_xi02_out) | (((popcount39_xi02_core_280 >> 0) & 0x01) << 0)
  popcount39_xi02_out = (popcount39_xi02_out) | (((popcount39_xi02_core_284 >> 0) & 0x01) << 1)
  popcount39_xi02_out = (popcount39_xi02_out) | (((popcount39_xi02_core_289 >> 0) & 0x01) << 2)
  popcount39_xi02_out = (popcount39_xi02_out) | (((popcount39_xi02_core_294 >> 0) & 0x01) << 3)
  popcount39_xi02_out = (popcount39_xi02_out) | (((popcount39_xi02_core_299 >> 0) & 0x01) << 4)
  popcount39_xi02_out = (popcount39_xi02_out) | ((0x00) << 5)
