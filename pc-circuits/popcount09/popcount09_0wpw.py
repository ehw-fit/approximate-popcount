...
def popcount09_0wpw(input_a):
  ...
  popcount09_0wpw_out = 0
  popcount09_0wpw_out = (popcount09_0wpw_out) | (((input_a >> 3) & 0x01) << 0)
  popcount09_0wpw_out = (popcount09_0wpw_out) | (((popcount09_0wpw_core_043 >> 0) & 0x01) << 1)
  popcount09_0wpw_out = (popcount09_0wpw_out) | (((popcount09_0wpw_core_048 >> 0) & 0x01) << 2)
  popcount09_0wpw_out = (popcount09_0wpw_out) | ((0x00) << 3)
