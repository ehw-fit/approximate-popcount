...
def popcount09_rx25(input_a):
  ...
  popcount09_rx25_out = 0
  popcount09_rx25_out = (popcount09_rx25_out) | (((popcount09_rx25_core_043 >> 0) & 0x01) << 0)
  popcount09_rx25_out = (popcount09_rx25_out) | (((popcount09_rx25_core_041 >> 0) & 0x01) << 1)
  popcount09_rx25_out = (popcount09_rx25_out) | (((popcount09_rx25_core_048 >> 0) & 0x01) << 2)
  popcount09_rx25_out = (popcount09_rx25_out) | ((0x00) << 3)
