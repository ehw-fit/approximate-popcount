...
def popcount09_mxwa(input_a):
  ...
  popcount09_mxwa_out = 0
  popcount09_mxwa_out = (popcount09_mxwa_out) | (((input_a >> 1) & 0x01) << 0)
  popcount09_mxwa_out = (popcount09_mxwa_out) | (((input_a >> 5) & 0x01) << 1)
  popcount09_mxwa_out = (popcount09_mxwa_out) | ((0x00) << 2)
  popcount09_mxwa_out = (popcount09_mxwa_out) | (((popcount09_mxwa_core_036 >> 0) & 0x01) << 3)
