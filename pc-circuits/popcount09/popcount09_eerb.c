...
uint64_t popcount09_eerb(uint64_t input_a){
  uint8_t popcount09_eerb_out = 0;
  uint8_t popcount09_eerb_core_011 = 0;
  uint8_t popcount09_eerb_core_012 = 0;
  uint8_t popcount09_eerb_core_013 = 0;
  uint8_t popcount09_eerb_core_017 = 0;
  uint8_t popcount09_eerb_core_018 = 0;
  uint8_t popcount09_eerb_core_022 = 0;
  uint8_t popcount09_eerb_core_024 = 0;
  uint8_t popcount09_eerb_core_025 = 0;
  uint8_t popcount09_eerb_core_027 = 0;
  uint8_t popcount09_eerb_core_028 = 0;
  uint8_t popcount09_eerb_core_030 = 0;
  uint8_t popcount09_eerb_core_033 = 0;
  uint8_t popcount09_eerb_core_034 = 0;
  uint8_t popcount09_eerb_core_035 = 0;
  uint8_t popcount09_eerb_core_036 = 0;
  uint8_t popcount09_eerb_core_037 = 0;
  uint8_t popcount09_eerb_core_038 = 0;
  uint8_t popcount09_eerb_core_040 = 0;
  uint8_t popcount09_eerb_core_041 = 0;
  uint8_t popcount09_eerb_core_045 = 0;
  uint8_t popcount09_eerb_core_048_not = 0;
  uint8_t popcount09_eerb_core_049 = 0;
  ...
  popcount09_eerb_out |= (0x01) << 0;
  popcount09_eerb_out |= (0x01) << 1;
  popcount09_eerb_out |= ((input_a[1] >> 0) & 0x01ull) << 2;
  popcount09_eerb_out |= (0x00) << 3;
