...
uint64_t popcount09_nxsc(uint64_t input_a){
  uint8_t popcount09_nxsc_out = 0;
  uint8_t popcount09_nxsc_core_011 = 0;
  uint8_t popcount09_nxsc_core_015 = 0;
  uint8_t popcount09_nxsc_core_016 = 0;
  uint8_t popcount09_nxsc_core_017 = 0;
  uint8_t popcount09_nxsc_core_021 = 0;
  uint8_t popcount09_nxsc_core_023_not = 0;
  uint8_t popcount09_nxsc_core_024 = 0;
  uint8_t popcount09_nxsc_core_029 = 0;
  uint8_t popcount09_nxsc_core_033_not = 0;
  uint8_t popcount09_nxsc_core_034_not = 0;
  uint8_t popcount09_nxsc_core_035_not = 0;
  uint8_t popcount09_nxsc_core_036 = 0;
  uint8_t popcount09_nxsc_core_037 = 0;
  uint8_t popcount09_nxsc_core_038 = 0;
  uint8_t popcount09_nxsc_core_040 = 0;
  uint8_t popcount09_nxsc_core_043 = 0;
  uint8_t popcount09_nxsc_core_044 = 0;
  uint8_t popcount09_nxsc_core_047 = 0;
  uint8_t popcount09_nxsc_core_048 = 0;
  uint8_t popcount09_nxsc_core_050 = 0;
  uint8_t popcount09_nxsc_core_051 = 0;
  ...
  popcount09_nxsc_out |= ((input_a[2] >> 0) & 0x01ull) << 0;
  popcount09_nxsc_out |= (0x01) << 1;
  popcount09_nxsc_out |= (0x01) << 2;
  popcount09_nxsc_out |= (0x00) << 3;
