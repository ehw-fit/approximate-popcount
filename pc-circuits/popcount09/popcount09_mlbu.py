...
def popcount09_mlbu(input_a):
  ...
  popcount09_mlbu_out = 0
  popcount09_mlbu_out = (popcount09_mlbu_out) | (((popcount09_mlbu_core_039 >> 0) & 0x01) << 0)
  popcount09_mlbu_out = (popcount09_mlbu_out) | (((popcount09_mlbu_core_043 >> 0) & 0x01) << 1)
  popcount09_mlbu_out = (popcount09_mlbu_out) | (((popcount09_mlbu_core_048 >> 0) & 0x01) << 2)
  popcount09_mlbu_out = (popcount09_mlbu_out) | (((popcount09_mlbu_core_047 >> 0) & 0x01) << 3)
