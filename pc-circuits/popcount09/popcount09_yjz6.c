...
uint64_t popcount09_yjz6(uint64_t input_a){
  uint8_t popcount09_yjz6_out = 0;
  uint8_t popcount09_yjz6_core_012_not = 0;
  uint8_t popcount09_yjz6_core_013_not = 0;
  uint8_t popcount09_yjz6_core_015 = 0;
  uint8_t popcount09_yjz6_core_017 = 0;
  uint8_t popcount09_yjz6_core_026 = 0;
  uint8_t popcount09_yjz6_core_030 = 0;
  uint8_t popcount09_yjz6_core_031 = 0;
  uint8_t popcount09_yjz6_core_033 = 0;
  uint8_t popcount09_yjz6_core_038 = 0;
  uint8_t popcount09_yjz6_core_043 = 0;
  uint8_t popcount09_yjz6_core_044 = 0;
  uint8_t popcount09_yjz6_core_046 = 0;
  uint8_t popcount09_yjz6_core_048 = 0;
  uint8_t popcount09_yjz6_core_049 = 0;
  ...
  popcount09_yjz6_out |= (0x01) << 0;
  popcount09_yjz6_out |= (0x00) << 1;
  popcount09_yjz6_out |= (0x01) << 2;
  popcount09_yjz6_out |= (0x00) << 3;
