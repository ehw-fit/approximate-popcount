...
def popcount09_vc7p(input_a):
  ...
  popcount09_vc7p_out = 0
  popcount09_vc7p_out = (popcount09_vc7p_out) | (((input_a >> 8) & 0x01) << 0)
  popcount09_vc7p_out = (popcount09_vc7p_out) | (((popcount09_vc7p_core_043 >> 0) & 0x01) << 1)
  popcount09_vc7p_out = (popcount09_vc7p_out) | (((popcount09_vc7p_core_048 >> 0) & 0x01) << 2)
  popcount09_vc7p_out = (popcount09_vc7p_out) | (((popcount09_vc7p_core_050 >> 0) & 0x01) << 3)
