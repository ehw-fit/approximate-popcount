...
uint64_t popcount09_bbni(uint64_t input_a){
  uint8_t popcount09_bbni_out = 0;
  uint8_t popcount09_bbni_core_011 = 0;
  uint8_t popcount09_bbni_core_012 = 0;
  uint8_t popcount09_bbni_core_013 = 0;
  uint8_t popcount09_bbni_core_014 = 0;
  uint8_t popcount09_bbni_core_015_not = 0;
  uint8_t popcount09_bbni_core_016 = 0;
  uint8_t popcount09_bbni_core_017 = 0;
  uint8_t popcount09_bbni_core_018 = 0;
  uint8_t popcount09_bbni_core_019 = 0;
  uint8_t popcount09_bbni_core_020 = 0;
  uint8_t popcount09_bbni_core_023 = 0;
  uint8_t popcount09_bbni_core_024 = 0;
  uint8_t popcount09_bbni_core_025 = 0;
  uint8_t popcount09_bbni_core_026 = 0;
  uint8_t popcount09_bbni_core_027 = 0;
  uint8_t popcount09_bbni_core_028 = 0;
  uint8_t popcount09_bbni_core_030 = 0;
  uint8_t popcount09_bbni_core_032 = 0;
  uint8_t popcount09_bbni_core_033 = 0;
  uint8_t popcount09_bbni_core_038 = 0;
  uint8_t popcount09_bbni_core_039 = 0;
  uint8_t popcount09_bbni_core_040 = 0;
  uint8_t popcount09_bbni_core_041 = 0;
  uint8_t popcount09_bbni_core_042 = 0;
  uint8_t popcount09_bbni_core_044 = 0;
  uint8_t popcount09_bbni_core_045 = 0;
  uint8_t popcount09_bbni_core_046 = 0;
  uint8_t popcount09_bbni_core_047 = 0;
  uint8_t popcount09_bbni_core_048 = 0;
  uint8_t popcount09_bbni_core_049 = 0;
  uint8_t popcount09_bbni_core_050 = 0;
  uint8_t popcount09_bbni_core_051 = 0;
  uint8_t popcount09_bbni_core_052 = 0;
  ...
  popcount09_bbni_out |= ((popcount09_bbni_core_040 >> 0) & 0x01ull) << 0;
  popcount09_bbni_out |= ((popcount09_bbni_core_030 >> 0) & 0x01ull) << 1;
  popcount09_bbni_out |= ((popcount09_bbni_core_048 >> 0) & 0x01ull) << 2;
  popcount09_bbni_out |= ((popcount09_bbni_core_050 >> 0) & 0x01ull) << 3;
