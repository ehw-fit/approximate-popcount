...
def popcount16_1x09(input_a):
  ...
  popcount16_1x09_out = 0
  popcount16_1x09_out = (popcount16_1x09_out) | (((input_a >> 0) & 0x01) << 0)
  popcount16_1x09_out = (popcount16_1x09_out) | (((popcount16_1x09_core_037 >> 0) & 0x01) << 1)
  popcount16_1x09_out = (popcount16_1x09_out) | (((popcount16_1x09_core_083 >> 0) & 0x01) << 2)
  popcount16_1x09_out = (popcount16_1x09_out) | (((popcount16_1x09_core_056 >> 0) & 0x01) << 3)
  popcount16_1x09_out = (popcount16_1x09_out) | (((popcount16_1x09_core_082 >> 0) & 0x01) << 4)
