...
def popcount16_fx4n(input_a):
  ...
  popcount16_fx4n_out = 0
  popcount16_fx4n_out = (popcount16_fx4n_out) | (((popcount16_fx4n_core_038 >> 0) & 0x01) << 0)
  popcount16_fx4n_out = (popcount16_fx4n_out) | (((popcount16_fx4n_core_090 >> 0) & 0x01) << 1)
  popcount16_fx4n_out = (popcount16_fx4n_out) | (((popcount16_fx4n_core_095 >> 0) & 0x01) << 2)
  popcount16_fx4n_out = (popcount16_fx4n_out) | (((popcount16_fx4n_core_100 >> 0) & 0x01) << 3)
  popcount16_fx4n_out = (popcount16_fx4n_out) | (((popcount16_fx4n_core_102 >> 0) & 0x01) << 4)
