...
def popcount18_g3qg(input_a):
  ...
  popcount18_g3qg_out = 0
  popcount18_g3qg_out = (popcount18_g3qg_out) | (((popcount18_g3qg_core_104 >> 0) & 0x01) << 0)
  popcount18_g3qg_out = (popcount18_g3qg_out) | (((popcount18_g3qg_core_108 >> 0) & 0x01) << 1)
  popcount18_g3qg_out = (popcount18_g3qg_out) | (((popcount18_g3qg_core_113 >> 0) & 0x01) << 2)
  popcount18_g3qg_out = (popcount18_g3qg_out) | (((popcount18_g3qg_core_118 >> 0) & 0x01) << 3)
  popcount18_g3qg_out = (popcount18_g3qg_out) | ((0x00) << 4)
