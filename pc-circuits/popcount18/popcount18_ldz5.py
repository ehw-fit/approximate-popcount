...
def popcount18_ldz5(input_a):
  ...
  popcount18_ldz5_out = 0
  popcount18_ldz5_out = (popcount18_ldz5_out) | (((popcount18_ldz5_core_104 >> 0) & 0x01) << 0)
  popcount18_ldz5_out = (popcount18_ldz5_out) | (((popcount18_ldz5_core_108 >> 0) & 0x01) << 1)
  popcount18_ldz5_out = (popcount18_ldz5_out) | (((popcount18_ldz5_core_113 >> 0) & 0x01) << 2)
  popcount18_ldz5_out = (popcount18_ldz5_out) | (((popcount18_ldz5_core_118 >> 0) & 0x01) << 3)
  popcount18_ldz5_out = (popcount18_ldz5_out) | (((popcount18_ldz5_core_120 >> 0) & 0x01) << 4)
