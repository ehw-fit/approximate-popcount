...
def popcount18_6uxx(input_a):
  ...
  popcount18_6uxx_out = 0
  popcount18_6uxx_out = (popcount18_6uxx_out) | (((popcount18_6uxx_core_069 >> 0) & 0x01) << 0)
  popcount18_6uxx_out = (popcount18_6uxx_out) | (((popcount18_6uxx_core_108 >> 0) & 0x01) << 1)
  popcount18_6uxx_out = (popcount18_6uxx_out) | (((popcount18_6uxx_core_113 >> 0) & 0x01) << 2)
  popcount18_6uxx_out = (popcount18_6uxx_out) | (((popcount18_6uxx_core_118 >> 0) & 0x01) << 3)
  popcount18_6uxx_out = (popcount18_6uxx_out) | ((0x00) << 4)
