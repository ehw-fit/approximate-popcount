...
def popcount38_ugnu(input_a):
  ...
  popcount38_ugnu_out = 0
  popcount38_ugnu_out = (popcount38_ugnu_out) | (((popcount38_ugnu_core_270 >> 0) & 0x01) << 0)
  popcount38_ugnu_out = (popcount38_ugnu_out) | (((popcount38_ugnu_core_274 >> 0) & 0x01) << 1)
  popcount38_ugnu_out = (popcount38_ugnu_out) | (((popcount38_ugnu_core_279 >> 0) & 0x01) << 2)
  popcount38_ugnu_out = (popcount38_ugnu_out) | (((popcount38_ugnu_core_284 >> 0) & 0x01) << 3)
  popcount38_ugnu_out = (popcount38_ugnu_out) | (((popcount38_ugnu_core_289 >> 0) & 0x01) << 4)
  popcount38_ugnu_out = (popcount38_ugnu_out) | (((popcount38_ugnu_core_291 >> 0) & 0x01) << 5)
