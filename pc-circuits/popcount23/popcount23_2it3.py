...
def popcount23_2it3(input_a):
  ...
  popcount23_2it3_out = 0
  popcount23_2it3_out = (popcount23_2it3_out) | (((input_a >> 20) & 0x01) << 0)
  popcount23_2it3_out = (popcount23_2it3_out) | ((0x01) << 1)
  popcount23_2it3_out = (popcount23_2it3_out) | (((input_a >> 19) & 0x01) << 2)
  popcount23_2it3_out = (popcount23_2it3_out) | (((input_a >> 13) & 0x01) << 3)
  popcount23_2it3_out = (popcount23_2it3_out) | ((0x00) << 4)
