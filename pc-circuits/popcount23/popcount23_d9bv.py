...
def popcount23_d9bv(input_a):
  ...
  popcount23_d9bv_out = 0
  popcount23_d9bv_out = (popcount23_d9bv_out) | (((popcount23_d9bv_core_148 >> 0) & 0x01) << 0)
  popcount23_d9bv_out = (popcount23_d9bv_out) | (((popcount23_d9bv_core_152 >> 0) & 0x01) << 1)
  popcount23_d9bv_out = (popcount23_d9bv_out) | (((popcount23_d9bv_core_157 >> 0) & 0x01) << 2)
  popcount23_d9bv_out = (popcount23_d9bv_out) | (((popcount23_d9bv_core_162 >> 0) & 0x01) << 3)
  popcount23_d9bv_out = (popcount23_d9bv_out) | (((popcount23_d9bv_core_164 >> 0) & 0x01) << 4)
