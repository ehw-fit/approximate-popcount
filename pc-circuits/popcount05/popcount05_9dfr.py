...
def popcount05_9dfr(input_a):
  ...
  popcount05_9dfr_out = 0
  popcount05_9dfr_out = (popcount05_9dfr_out) | (((popcount05_9dfr_core_015 >> 0) & 0x01) << 0)
  popcount05_9dfr_out = (popcount05_9dfr_out) | (((popcount05_9dfr_core_019 >> 0) & 0x01) << 1)
  popcount05_9dfr_out = (popcount05_9dfr_out) | (((popcount05_9dfr_core_018 >> 0) & 0x01) << 2)
