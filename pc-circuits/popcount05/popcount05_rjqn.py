...
def popcount05_rjqn(input_a):
  ...
  popcount05_rjqn_out = 0
  popcount05_rjqn_out = (popcount05_rjqn_out) | ((0x00) << 0)
  popcount05_rjqn_out = (popcount05_rjqn_out) | ((0x01) << 1)
  popcount05_rjqn_out = (popcount05_rjqn_out) | ((0x00) << 2)
