...
def popcount32_ckmq(input_a):
  ...
  popcount32_ckmq_out = 0
  popcount32_ckmq_out = (popcount32_ckmq_out) | (((input_a >> 0) & 0x01) << 0)
  popcount32_ckmq_out = (popcount32_ckmq_out) | (((popcount32_ckmq_core_211 >> 0) & 0x01) << 1)
  popcount32_ckmq_out = (popcount32_ckmq_out) | (((popcount32_ckmq_core_211 >> 0) & 0x01) << 2)
  popcount32_ckmq_out = (popcount32_ckmq_out) | (((popcount32_ckmq_core_211 >> 0) & 0x01) << 3)
  popcount32_ckmq_out = (popcount32_ckmq_out) | (((input_a >> 10) & 0x01) << 4)
  popcount32_ckmq_out = (popcount32_ckmq_out) | ((0x00) << 5)
