...
def popcount32_eq50(input_a):
  ...
  popcount32_eq50_out = 0
  popcount32_eq50_out = (popcount32_eq50_out) | (((input_a >> 17) & 0x01) << 0)
  popcount32_eq50_out = (popcount32_eq50_out) | (((popcount32_eq50_core_208 >> 0) & 0x01) << 1)
  popcount32_eq50_out = (popcount32_eq50_out) | (((popcount32_eq50_core_213 >> 0) & 0x01) << 2)
  popcount32_eq50_out = (popcount32_eq50_out) | (((popcount32_eq50_core_218 >> 0) & 0x01) << 3)
  popcount32_eq50_out = (popcount32_eq50_out) | (((popcount32_eq50_core_223 >> 0) & 0x01) << 4)
  popcount32_eq50_out = (popcount32_eq50_out) | (((popcount32_eq50_core_222 >> 0) & 0x01) << 5)
