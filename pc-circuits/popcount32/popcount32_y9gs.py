...
def popcount32_y9gs(input_a):
  ...
  popcount32_y9gs_out = 0
  popcount32_y9gs_out = (popcount32_y9gs_out) | ((0x01) << 0)
  popcount32_y9gs_out = (popcount32_y9gs_out) | ((0x01) << 1)
  popcount32_y9gs_out = (popcount32_y9gs_out) | (((input_a >> 3) & 0x01) << 2)
  popcount32_y9gs_out = (popcount32_y9gs_out) | ((0x00) << 3)
  popcount32_y9gs_out = (popcount32_y9gs_out) | ((0x00) << 4)
  popcount32_y9gs_out = (popcount32_y9gs_out) | (((input_a >> 11) & 0x01) << 5)
