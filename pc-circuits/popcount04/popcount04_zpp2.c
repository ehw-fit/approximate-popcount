...
uint64_t popcount04_zpp2(uint64_t input_a){
  uint8_t popcount04_zpp2_out = 0;
  uint8_t popcount04_zpp2_core_006 = 0;
  uint8_t popcount04_zpp2_core_008 = 0;
  uint8_t popcount04_zpp2_core_009 = 0;
  uint8_t popcount04_zpp2_core_011 = 0;
  uint8_t popcount04_zpp2_core_012 = 0;
  uint8_t popcount04_zpp2_core_013 = 0;
  uint8_t popcount04_zpp2_core_014 = 0;
  uint8_t popcount04_zpp2_core_016 = 0;
  ...
  popcount04_zpp2_out |= ((input_a[1] >> 0) & 0x01ull) << 0;
  popcount04_zpp2_out |= ((popcount04_zpp2_core_014 >> 0) & 0x01ull) << 1;
  popcount04_zpp2_out |= ((popcount04_zpp2_core_013 >> 0) & 0x01ull) << 2;
