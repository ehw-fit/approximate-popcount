...
def popcount04_kts7(input_a):
  ...
  popcount04_kts7_out = 0
  popcount04_kts7_out = (popcount04_kts7_out) | (((popcount04_kts7_core_010 >> 0) & 0x01) << 0)
  popcount04_kts7_out = (popcount04_kts7_out) | (((popcount04_kts7_core_014 >> 0) & 0x01) << 1)
  popcount04_kts7_out = (popcount04_kts7_out) | ((0x00) << 2)
