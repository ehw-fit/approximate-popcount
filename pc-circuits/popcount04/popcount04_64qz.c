...
uint64_t popcount04_64qz(uint64_t input_a){
  uint8_t popcount04_64qz_out = 0;
  uint8_t popcount04_64qz_core_006 = 0;
  uint8_t popcount04_64qz_core_007 = 0;
  uint8_t popcount04_64qz_core_009 = 0;
  uint8_t popcount04_64qz_core_010 = 0;
  uint8_t popcount04_64qz_core_011 = 0;
  uint8_t popcount04_64qz_core_012 = 0;
  uint8_t popcount04_64qz_core_013 = 0;
  uint8_t popcount04_64qz_core_014 = 0;
  ...
  popcount04_64qz_out |= ((input_a[0] >> 0) & 0x01ull) << 0;
  popcount04_64qz_out |= ((popcount04_64qz_core_014 >> 0) & 0x01ull) << 1;
  popcount04_64qz_out |= ((popcount04_64qz_core_013 >> 0) & 0x01ull) << 2;
