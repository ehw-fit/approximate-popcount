...
def popcount10_pdrv(input_a):
  ...
  popcount10_pdrv_out = 0
  popcount10_pdrv_out = (popcount10_pdrv_out) | (((input_a >> 4) & 0x01) << 0)
  popcount10_pdrv_out = (popcount10_pdrv_out) | (((popcount10_pdrv_core_046 >> 0) & 0x01) << 1)
  popcount10_pdrv_out = (popcount10_pdrv_out) | (((input_a >> 5) & 0x01) << 2)
  popcount10_pdrv_out = (popcount10_pdrv_out) | (((popcount10_pdrv_core_054 >> 0) & 0x01) << 3)
