...
def popcount10_izrs(input_a):
  ...
  popcount10_izrs_out = 0
  popcount10_izrs_out = (popcount10_izrs_out) | (((popcount10_izrs_core_046 >> 0) & 0x01) << 0)
  popcount10_izrs_out = (popcount10_izrs_out) | (((popcount10_izrs_core_050 >> 0) & 0x01) << 1)
  popcount10_izrs_out = (popcount10_izrs_out) | (((popcount10_izrs_core_055 >> 0) & 0x01) << 2)
  popcount10_izrs_out = (popcount10_izrs_out) | (((popcount10_izrs_core_057 >> 0) & 0x01) << 3)
