...
def popcount10_zdql(input_a):
  ...
  popcount10_zdql_out = 0
  popcount10_zdql_out = (popcount10_zdql_out) | (((popcount10_zdql_core_046 >> 0) & 0x01) << 0)
  popcount10_zdql_out = (popcount10_zdql_out) | (((popcount10_zdql_core_050 >> 0) & 0x01) << 1)
  popcount10_zdql_out = (popcount10_zdql_out) | (((popcount10_zdql_core_055 >> 0) & 0x01) << 2)
  popcount10_zdql_out = (popcount10_zdql_out) | (((popcount10_zdql_core_057 >> 0) & 0x01) << 3)
