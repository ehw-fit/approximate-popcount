...
def popcount10_twl4(input_a):
  ...
  popcount10_twl4_out = 0
  popcount10_twl4_out = (popcount10_twl4_out) | (((popcount10_twl4_core_046_not >> 0) & 0x01) << 0)
  popcount10_twl4_out = (popcount10_twl4_out) | (((popcount10_twl4_core_050 >> 0) & 0x01) << 1)
  popcount10_twl4_out = (popcount10_twl4_out) | (((popcount10_twl4_core_055 >> 0) & 0x01) << 2)
  popcount10_twl4_out = (popcount10_twl4_out) | (((popcount10_twl4_core_057 >> 0) & 0x01) << 3)
