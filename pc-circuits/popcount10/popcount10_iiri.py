...
def popcount10_iiri(input_a):
  ...
  popcount10_iiri_out = 0
  popcount10_iiri_out = (popcount10_iiri_out) | (((popcount10_iiri_core_028 >> 0) & 0x01) << 0)
  popcount10_iiri_out = (popcount10_iiri_out) | (((popcount10_iiri_core_050 >> 0) & 0x01) << 1)
  popcount10_iiri_out = (popcount10_iiri_out) | (((popcount10_iiri_core_055 >> 0) & 0x01) << 2)
  popcount10_iiri_out = (popcount10_iiri_out) | (((popcount10_iiri_core_057 >> 0) & 0x01) << 3)
