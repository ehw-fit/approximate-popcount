...
def popcount10_hlvo(input_a):
  ...
  popcount10_hlvo_out = 0
  popcount10_hlvo_out = (popcount10_hlvo_out) | (((input_a >> 3) & 0x01) << 0)
  popcount10_hlvo_out = (popcount10_hlvo_out) | (((popcount10_hlvo_core_050 >> 0) & 0x01) << 1)
  popcount10_hlvo_out = (popcount10_hlvo_out) | (((popcount10_hlvo_core_055 >> 0) & 0x01) << 2)
  popcount10_hlvo_out = (popcount10_hlvo_out) | (((popcount10_hlvo_core_057 >> 0) & 0x01) << 3)
