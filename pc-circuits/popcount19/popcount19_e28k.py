...
def popcount19_e28k(input_a):
  ...
  popcount19_e28k_out = 0
  popcount19_e28k_out = (popcount19_e28k_out) | (((popcount19_e28k_core_114 >> 0) & 0x01) << 0)
  popcount19_e28k_out = (popcount19_e28k_out) | (((popcount19_e28k_core_118 >> 0) & 0x01) << 1)
  popcount19_e28k_out = (popcount19_e28k_out) | (((popcount19_e28k_core_123 >> 0) & 0x01) << 2)
  popcount19_e28k_out = (popcount19_e28k_out) | (((popcount19_e28k_core_128 >> 0) & 0x01) << 3)
  popcount19_e28k_out = (popcount19_e28k_out) | (((popcount19_e28k_core_130 >> 0) & 0x01) << 4)
