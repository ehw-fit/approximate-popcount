...
uint64_t popcount19_iinv(uint64_t input_a){
  uint8_t popcount19_iinv_out = 0;
  uint8_t popcount19_iinv_core_022 = 0;
  uint8_t popcount19_iinv_core_026 = 0;
  uint8_t popcount19_iinv_core_028 = 0;
  uint8_t popcount19_iinv_core_030 = 0;
  uint8_t popcount19_iinv_core_031 = 0;
  uint8_t popcount19_iinv_core_032 = 0;
  uint8_t popcount19_iinv_core_033 = 0;
  uint8_t popcount19_iinv_core_034 = 0;
  uint8_t popcount19_iinv_core_036 = 0;
  uint8_t popcount19_iinv_core_037 = 0;
  uint8_t popcount19_iinv_core_039 = 0;
  uint8_t popcount19_iinv_core_040 = 0;
  uint8_t popcount19_iinv_core_041 = 0;
  uint8_t popcount19_iinv_core_045 = 0;
  uint8_t popcount19_iinv_core_046 = 0;
  uint8_t popcount19_iinv_core_047 = 0;
  uint8_t popcount19_iinv_core_048 = 0;
  uint8_t popcount19_iinv_core_049 = 0;
  uint8_t popcount19_iinv_core_052 = 0;
  uint8_t popcount19_iinv_core_053 = 0;
  uint8_t popcount19_iinv_core_054 = 0;
  uint8_t popcount19_iinv_core_055 = 0;
  uint8_t popcount19_iinv_core_057 = 0;
  uint8_t popcount19_iinv_core_058_not = 0;
  uint8_t popcount19_iinv_core_059 = 0;
  uint8_t popcount19_iinv_core_060 = 0;
  uint8_t popcount19_iinv_core_061 = 0;
  uint8_t popcount19_iinv_core_062 = 0;
  uint8_t popcount19_iinv_core_063 = 0;
  uint8_t popcount19_iinv_core_066 = 0;
  uint8_t popcount19_iinv_core_068 = 0;
  uint8_t popcount19_iinv_core_070 = 0;
  uint8_t popcount19_iinv_core_073 = 0;
  uint8_t popcount19_iinv_core_076 = 0;
  uint8_t popcount19_iinv_core_077 = 0;
  uint8_t popcount19_iinv_core_078 = 0;
  uint8_t popcount19_iinv_core_079_not = 0;
  uint8_t popcount19_iinv_core_080 = 0;
  uint8_t popcount19_iinv_core_081 = 0;
  uint8_t popcount19_iinv_core_082 = 0;
  uint8_t popcount19_iinv_core_083 = 0;
  uint8_t popcount19_iinv_core_090 = 0;
  uint8_t popcount19_iinv_core_091 = 0;
  uint8_t popcount19_iinv_core_093 = 0;
  uint8_t popcount19_iinv_core_095_not = 0;
  uint8_t popcount19_iinv_core_096 = 0;
  uint8_t popcount19_iinv_core_100 = 0;
  uint8_t popcount19_iinv_core_102 = 0;
  uint8_t popcount19_iinv_core_105 = 0;
  uint8_t popcount19_iinv_core_106 = 0;
  uint8_t popcount19_iinv_core_108_not = 0;
  uint8_t popcount19_iinv_core_109 = 0;
  uint8_t popcount19_iinv_core_110 = 0;
  uint8_t popcount19_iinv_core_112 = 0;
  uint8_t popcount19_iinv_core_114 = 0;
  uint8_t popcount19_iinv_core_120 = 0;
  uint8_t popcount19_iinv_core_123 = 0;
  uint8_t popcount19_iinv_core_124 = 0;
  uint8_t popcount19_iinv_core_127_not = 0;
  uint8_t popcount19_iinv_core_128 = 0;
  uint8_t popcount19_iinv_core_129 = 0;
  uint8_t popcount19_iinv_core_130 = 0;
  uint8_t popcount19_iinv_core_131 = 0;
  uint8_t popcount19_iinv_core_132 = 0;
  uint8_t popcount19_iinv_core_135 = 0;
  ...
  popcount19_iinv_out |= ((input_a[14] >> 0) & 0x01ull) << 0;
  popcount19_iinv_out |= (0x00) << 1;
  popcount19_iinv_out |= ((popcount19_iinv_core_123 >> 0) & 0x01ull) << 2;
  popcount19_iinv_out |= ((popcount19_iinv_core_128 >> 0) & 0x01ull) << 3;
  popcount19_iinv_out |= ((popcount19_iinv_core_129 >> 0) & 0x01ull) << 4;
