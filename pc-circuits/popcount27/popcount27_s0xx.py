...
def popcount27_s0xx(input_a):
  ...
  popcount27_s0xx_out = 0
  popcount27_s0xx_out = (popcount27_s0xx_out) | (((input_a >> 3) & 0x01) << 0)
  popcount27_s0xx_out = (popcount27_s0xx_out) | (((input_a >> 0) & 0x01) << 1)
  popcount27_s0xx_out = (popcount27_s0xx_out) | ((0x01) << 2)
  popcount27_s0xx_out = (popcount27_s0xx_out) | (((input_a >> 10) & 0x01) << 3)
  popcount27_s0xx_out = (popcount27_s0xx_out) | ((0x00) << 4)
