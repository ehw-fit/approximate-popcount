...
def popcount25_yde7(input_a):
  ...
  popcount25_yde7_out = 0
  popcount25_yde7_out = (popcount25_yde7_out) | (((popcount25_yde7_core_162 >> 0) & 0x01) << 0)
  popcount25_yde7_out = (popcount25_yde7_out) | (((popcount25_yde7_core_166 >> 0) & 0x01) << 1)
  popcount25_yde7_out = (popcount25_yde7_out) | (((popcount25_yde7_core_171 >> 0) & 0x01) << 2)
  popcount25_yde7_out = (popcount25_yde7_out) | (((popcount25_yde7_core_176 >> 0) & 0x01) << 3)
  popcount25_yde7_out = (popcount25_yde7_out) | (((popcount25_yde7_core_178 >> 0) & 0x01) << 4)
