...
def popcount25_pbml(input_a):
  ...
  popcount25_pbml_out = 0
  popcount25_pbml_out = (popcount25_pbml_out) | (((popcount25_pbml_core_162 >> 0) & 0x01) << 0)
  popcount25_pbml_out = (popcount25_pbml_out) | (((popcount25_pbml_core_166 >> 0) & 0x01) << 1)
  popcount25_pbml_out = (popcount25_pbml_out) | (((popcount25_pbml_core_171 >> 0) & 0x01) << 2)
  popcount25_pbml_out = (popcount25_pbml_out) | (((popcount25_pbml_core_176 >> 0) & 0x01) << 3)
  popcount25_pbml_out = (popcount25_pbml_out) | (((popcount25_pbml_core_178 >> 0) & 0x01) << 4)
