...
def popcount25_pm72(input_a):
  ...
  popcount25_pm72_out = 0
  popcount25_pm72_out = (popcount25_pm72_out) | (((popcount25_pm72_core_096 >> 0) & 0x01) << 0)
  popcount25_pm72_out = (popcount25_pm72_out) | (((popcount25_pm72_core_166 >> 0) & 0x01) << 1)
  popcount25_pm72_out = (popcount25_pm72_out) | (((popcount25_pm72_core_171 >> 0) & 0x01) << 2)
  popcount25_pm72_out = (popcount25_pm72_out) | (((popcount25_pm72_core_176 >> 0) & 0x01) << 3)
  popcount25_pm72_out = (popcount25_pm72_out) | (((popcount25_pm72_core_178 >> 0) & 0x01) << 4)
