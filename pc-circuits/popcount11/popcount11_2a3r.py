...
def popcount11_2a3r(input_a):
  ...
  popcount11_2a3r_out = 0
  popcount11_2a3r_out = (popcount11_2a3r_out) | (((input_a >> 3) & 0x01) << 0)
  popcount11_2a3r_out = (popcount11_2a3r_out) | (((popcount11_2a3r_core_056 >> 0) & 0x01) << 1)
  popcount11_2a3r_out = (popcount11_2a3r_out) | (((popcount11_2a3r_core_063 >> 0) & 0x01) << 2)
  popcount11_2a3r_out = (popcount11_2a3r_out) | (((popcount11_2a3r_core_062 >> 0) & 0x01) << 3)
