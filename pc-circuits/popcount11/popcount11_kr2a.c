...
uint64_t popcount11_kr2a(uint64_t input_a){
  uint8_t popcount11_kr2a_out = 0;
  uint8_t popcount11_kr2a_core_014 = 0;
  uint8_t popcount11_kr2a_core_015_not = 0;
  uint8_t popcount11_kr2a_core_016_not = 0;
  uint8_t popcount11_kr2a_core_017 = 0;
  uint8_t popcount11_kr2a_core_022 = 0;
  uint8_t popcount11_kr2a_core_024 = 0;
  uint8_t popcount11_kr2a_core_026_not = 0;
  uint8_t popcount11_kr2a_core_027_not = 0;
  uint8_t popcount11_kr2a_core_030 = 0;
  uint8_t popcount11_kr2a_core_033 = 0;
  uint8_t popcount11_kr2a_core_034 = 0;
  uint8_t popcount11_kr2a_core_035 = 0;
  uint8_t popcount11_kr2a_core_036 = 0;
  uint8_t popcount11_kr2a_core_038_not = 0;
  uint8_t popcount11_kr2a_core_039 = 0;
  uint8_t popcount11_kr2a_core_043_not = 0;
  uint8_t popcount11_kr2a_core_045_not = 0;
  uint8_t popcount11_kr2a_core_050 = 0;
  uint8_t popcount11_kr2a_core_052 = 0;
  uint8_t popcount11_kr2a_core_054 = 0;
  uint8_t popcount11_kr2a_core_058_not = 0;
  uint8_t popcount11_kr2a_core_059 = 0;
  uint8_t popcount11_kr2a_core_060 = 0;
  uint8_t popcount11_kr2a_core_062_not = 0;
  uint8_t popcount11_kr2a_core_063 = 0;
  uint8_t popcount11_kr2a_core_069 = 0;
  uint8_t popcount11_kr2a_core_070_not = 0;
  ...
  popcount11_kr2a_out |= (0x00) << 0;
  popcount11_kr2a_out |= (0x01) << 1;
  popcount11_kr2a_out |= ((input_a[7] >> 0) & 0x01ull) << 2;
  popcount11_kr2a_out |= (0x00) << 3;
