...
uint64_t popcount11_dxgc(uint64_t input_a){
  uint8_t popcount11_dxgc_out = 0;
  uint8_t popcount11_dxgc_core_013 = 0;
  uint8_t popcount11_dxgc_core_015 = 0;
  uint8_t popcount11_dxgc_core_016 = 0;
  uint8_t popcount11_dxgc_core_018 = 0;
  uint8_t popcount11_dxgc_core_019 = 0;
  uint8_t popcount11_dxgc_core_021 = 0;
  uint8_t popcount11_dxgc_core_022 = 0;
  uint8_t popcount11_dxgc_core_024 = 0;
  uint8_t popcount11_dxgc_core_026 = 0;
  uint8_t popcount11_dxgc_core_027 = 0;
  uint8_t popcount11_dxgc_core_030 = 0;
  uint8_t popcount11_dxgc_core_031 = 0;
  uint8_t popcount11_dxgc_core_032 = 0;
  uint8_t popcount11_dxgc_core_033 = 0;
  uint8_t popcount11_dxgc_core_034 = 0;
  uint8_t popcount11_dxgc_core_037 = 0;
  uint8_t popcount11_dxgc_core_038 = 0;
  uint8_t popcount11_dxgc_core_040 = 0;
  uint8_t popcount11_dxgc_core_041 = 0;
  uint8_t popcount11_dxgc_core_042 = 0;
  uint8_t popcount11_dxgc_core_043 = 0;
  uint8_t popcount11_dxgc_core_044 = 0;
  uint8_t popcount11_dxgc_core_045 = 0;
  uint8_t popcount11_dxgc_core_046 = 0;
  uint8_t popcount11_dxgc_core_047 = 0;
  uint8_t popcount11_dxgc_core_048 = 0;
  uint8_t popcount11_dxgc_core_051 = 0;
  uint8_t popcount11_dxgc_core_052 = 0;
  uint8_t popcount11_dxgc_core_054 = 0;
  uint8_t popcount11_dxgc_core_055 = 0;
  uint8_t popcount11_dxgc_core_058 = 0;
  uint8_t popcount11_dxgc_core_059 = 0;
  uint8_t popcount11_dxgc_core_061 = 0;
  uint8_t popcount11_dxgc_core_062 = 0;
  uint8_t popcount11_dxgc_core_063 = 0;
  uint8_t popcount11_dxgc_core_064 = 0;
  uint8_t popcount11_dxgc_core_065 = 0;
  uint8_t popcount11_dxgc_core_066 = 0;
  uint8_t popcount11_dxgc_core_067 = 0;
  uint8_t popcount11_dxgc_core_068 = 0;
  uint8_t popcount11_dxgc_core_069 = 0;
  uint8_t popcount11_dxgc_core_070 = 0;
  ...
  popcount11_dxgc_out |= ((popcount11_dxgc_core_022 >> 0) & 0x01ull) << 0;
  popcount11_dxgc_out |= ((popcount11_dxgc_core_058 >> 0) & 0x01ull) << 1;
  popcount11_dxgc_out |= ((popcount11_dxgc_core_063 >> 0) & 0x01ull) << 2;
  popcount11_dxgc_out |= ((popcount11_dxgc_core_065 >> 0) & 0x01ull) << 3;
