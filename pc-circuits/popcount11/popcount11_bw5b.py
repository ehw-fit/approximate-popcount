...
def popcount11_bw5b(input_a):
  ...
  popcount11_bw5b_out = 0
  popcount11_bw5b_out = (popcount11_bw5b_out) | (((input_a >> 0) & 0x01) << 0)
  popcount11_bw5b_out = (popcount11_bw5b_out) | (((popcount11_bw5b_core_056 >> 0) & 0x01) << 1)
  popcount11_bw5b_out = (popcount11_bw5b_out) | (((popcount11_bw5b_core_063 >> 0) & 0x01) << 2)
  popcount11_bw5b_out = (popcount11_bw5b_out) | (((popcount11_bw5b_core_065 >> 0) & 0x01) << 3)
