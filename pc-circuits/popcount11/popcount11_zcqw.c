...
uint64_t popcount11_zcqw(uint64_t input_a){
  uint8_t popcount11_zcqw_out = 0;
  uint8_t popcount11_zcqw_core_013 = 0;
  uint8_t popcount11_zcqw_core_014 = 0;
  uint8_t popcount11_zcqw_core_015 = 0;
  uint8_t popcount11_zcqw_core_016 = 0;
  uint8_t popcount11_zcqw_core_017 = 0;
  uint8_t popcount11_zcqw_core_018 = 0;
  uint8_t popcount11_zcqw_core_019 = 0;
  uint8_t popcount11_zcqw_core_021 = 0;
  uint8_t popcount11_zcqw_core_022 = 0;
  uint8_t popcount11_zcqw_core_023 = 0;
  uint8_t popcount11_zcqw_core_024 = 0;
  uint8_t popcount11_zcqw_core_025 = 0;
  uint8_t popcount11_zcqw_core_026 = 0;
  uint8_t popcount11_zcqw_core_027 = 0;
  uint8_t popcount11_zcqw_core_030 = 0;
  uint8_t popcount11_zcqw_core_031 = 0;
  uint8_t popcount11_zcqw_core_032 = 0;
  uint8_t popcount11_zcqw_core_033 = 0;
  uint8_t popcount11_zcqw_core_034 = 0;
  uint8_t popcount11_zcqw_core_036 = 0;
  uint8_t popcount11_zcqw_core_037 = 0;
  uint8_t popcount11_zcqw_core_038 = 0;
  uint8_t popcount11_zcqw_core_039 = 0;
  uint8_t popcount11_zcqw_core_041 = 0;
  uint8_t popcount11_zcqw_core_042 = 0;
  uint8_t popcount11_zcqw_core_044 = 0;
  uint8_t popcount11_zcqw_core_045 = 0;
  uint8_t popcount11_zcqw_core_046 = 0;
  uint8_t popcount11_zcqw_core_047 = 0;
  uint8_t popcount11_zcqw_core_048 = 0;
  uint8_t popcount11_zcqw_core_050 = 0;
  uint8_t popcount11_zcqw_core_053 = 0;
  uint8_t popcount11_zcqw_core_054 = 0;
  uint8_t popcount11_zcqw_core_055 = 0;
  uint8_t popcount11_zcqw_core_056 = 0;
  uint8_t popcount11_zcqw_core_057 = 0;
  uint8_t popcount11_zcqw_core_058 = 0;
  uint8_t popcount11_zcqw_core_059 = 0;
  uint8_t popcount11_zcqw_core_060 = 0;
  uint8_t popcount11_zcqw_core_061 = 0;
  uint8_t popcount11_zcqw_core_062 = 0;
  uint8_t popcount11_zcqw_core_063 = 0;
  uint8_t popcount11_zcqw_core_064 = 0;
  uint8_t popcount11_zcqw_core_065 = 0;
  uint8_t popcount11_zcqw_core_067 = 0;
  uint8_t popcount11_zcqw_core_069 = 0;
  ...
  popcount11_zcqw_out |= ((input_a[9] >> 0) & 0x01ull) << 0;
  popcount11_zcqw_out |= ((popcount11_zcqw_core_058 >> 0) & 0x01ull) << 1;
  popcount11_zcqw_out |= ((popcount11_zcqw_core_063 >> 0) & 0x01ull) << 2;
  popcount11_zcqw_out |= ((popcount11_zcqw_core_065 >> 0) & 0x01ull) << 3;
