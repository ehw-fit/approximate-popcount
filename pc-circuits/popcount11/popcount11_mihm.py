...
def popcount11_mihm(input_a):
  ...
  popcount11_mihm_out = 0
  popcount11_mihm_out = (popcount11_mihm_out) | (((popcount11_mihm_core_046 >> 0) & 0x01) << 0)
  popcount11_mihm_out = (popcount11_mihm_out) | (((popcount11_mihm_core_058 >> 0) & 0x01) << 1)
  popcount11_mihm_out = (popcount11_mihm_out) | (((popcount11_mihm_core_063 >> 0) & 0x01) << 2)
  popcount11_mihm_out = (popcount11_mihm_out) | (((popcount11_mihm_core_065 >> 0) & 0x01) << 3)
