...
def popcount11_bprq(input_a):
  ...
  popcount11_bprq_out = 0
  popcount11_bprq_out = (popcount11_bprq_out) | (((popcount11_bprq_core_050 >> 0) & 0x01) << 0)
  popcount11_bprq_out = (popcount11_bprq_out) | (((popcount11_bprq_core_058 >> 0) & 0x01) << 1)
  popcount11_bprq_out = (popcount11_bprq_out) | (((popcount11_bprq_core_063 >> 0) & 0x01) << 2)
  popcount11_bprq_out = (popcount11_bprq_out) | (((popcount11_bprq_core_065 >> 0) & 0x01) << 3)
