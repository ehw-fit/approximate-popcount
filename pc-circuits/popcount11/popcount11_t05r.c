...
uint64_t popcount11_t05r(uint64_t input_a){
  uint8_t popcount11_t05r_out = 0;
  uint8_t popcount11_t05r_core_013 = 0;
  uint8_t popcount11_t05r_core_014 = 0;
  uint8_t popcount11_t05r_core_015 = 0;
  uint8_t popcount11_t05r_core_016 = 0;
  uint8_t popcount11_t05r_core_017 = 0;
  uint8_t popcount11_t05r_core_018 = 0;
  uint8_t popcount11_t05r_core_019 = 0;
  uint8_t popcount11_t05r_core_021 = 0;
  uint8_t popcount11_t05r_core_023 = 0;
  uint8_t popcount11_t05r_core_024 = 0;
  uint8_t popcount11_t05r_core_025 = 0;
  uint8_t popcount11_t05r_core_026 = 0;
  uint8_t popcount11_t05r_core_027 = 0;
  uint8_t popcount11_t05r_core_029 = 0;
  uint8_t popcount11_t05r_core_030 = 0;
  uint8_t popcount11_t05r_core_031 = 0;
  uint8_t popcount11_t05r_core_032 = 0;
  uint8_t popcount11_t05r_core_033 = 0;
  uint8_t popcount11_t05r_core_034 = 0;
  uint8_t popcount11_t05r_core_035_not = 0;
  uint8_t popcount11_t05r_core_037 = 0;
  uint8_t popcount11_t05r_core_038 = 0;
  uint8_t popcount11_t05r_core_039_not = 0;
  uint8_t popcount11_t05r_core_042 = 0;
  uint8_t popcount11_t05r_core_043 = 0;
  uint8_t popcount11_t05r_core_044 = 0;
  uint8_t popcount11_t05r_core_045 = 0;
  uint8_t popcount11_t05r_core_046 = 0;
  uint8_t popcount11_t05r_core_047 = 0;
  uint8_t popcount11_t05r_core_048 = 0;
  uint8_t popcount11_t05r_core_050 = 0;
  uint8_t popcount11_t05r_core_052 = 0;
  uint8_t popcount11_t05r_core_053 = 0;
  uint8_t popcount11_t05r_core_055 = 0;
  uint8_t popcount11_t05r_core_056 = 0;
  uint8_t popcount11_t05r_core_057 = 0;
  uint8_t popcount11_t05r_core_058 = 0;
  uint8_t popcount11_t05r_core_059 = 0;
  uint8_t popcount11_t05r_core_060 = 0;
  uint8_t popcount11_t05r_core_061 = 0;
  uint8_t popcount11_t05r_core_062 = 0;
  uint8_t popcount11_t05r_core_063 = 0;
  uint8_t popcount11_t05r_core_064 = 0;
  uint8_t popcount11_t05r_core_065 = 0;
  uint8_t popcount11_t05r_core_066 = 0;
  ...
  popcount11_t05r_out |= ((popcount11_t05r_core_029 >> 0) & 0x01ull) << 0;
  popcount11_t05r_out |= ((popcount11_t05r_core_058 >> 0) & 0x01ull) << 1;
  popcount11_t05r_out |= ((popcount11_t05r_core_063 >> 0) & 0x01ull) << 2;
  popcount11_t05r_out |= ((popcount11_t05r_core_065 >> 0) & 0x01ull) << 3;
