...
def popcount11_iz9m(input_a):
  ...
  popcount11_iz9m_out = 0
  popcount11_iz9m_out = (popcount11_iz9m_out) | (((popcount11_iz9m_core_053 >> 0) & 0x01) << 0)
  popcount11_iz9m_out = (popcount11_iz9m_out) | (((popcount11_iz9m_core_046 >> 0) & 0x01) << 1)
  popcount11_iz9m_out = (popcount11_iz9m_out) | (((popcount11_iz9m_core_063 >> 0) & 0x01) << 2)
  popcount11_iz9m_out = (popcount11_iz9m_out) | (((popcount11_iz9m_core_065 >> 0) & 0x01) << 3)
