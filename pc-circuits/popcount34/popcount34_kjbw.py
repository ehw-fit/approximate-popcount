...
def popcount34_kjbw(input_a):
  ...
  popcount34_kjbw_out = 0
  popcount34_kjbw_out = (popcount34_kjbw_out) | (((input_a >> 20) & 0x01) << 0)
  popcount34_kjbw_out = (popcount34_kjbw_out) | (((popcount34_kjbw_core_228 >> 0) & 0x01) << 1)
  popcount34_kjbw_out = (popcount34_kjbw_out) | (((popcount34_kjbw_core_235 >> 0) & 0x01) << 2)
  popcount34_kjbw_out = (popcount34_kjbw_out) | (((popcount34_kjbw_core_240 >> 0) & 0x01) << 3)
  popcount34_kjbw_out = (popcount34_kjbw_out) | (((popcount34_kjbw_core_245 >> 0) & 0x01) << 4)
  popcount34_kjbw_out = (popcount34_kjbw_out) | (((popcount34_kjbw_core_247 >> 0) & 0x01) << 5)
