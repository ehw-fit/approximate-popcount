...
def popcount34_idk9(input_a):
  ...
  popcount34_idk9_out = 0
  popcount34_idk9_out = (popcount34_idk9_out) | (((input_a >> 0) & 0x01) << 0)
  popcount34_idk9_out = (popcount34_idk9_out) | (((popcount34_idk9_core_230 >> 0) & 0x01) << 1)
  popcount34_idk9_out = (popcount34_idk9_out) | (((popcount34_idk9_core_235 >> 0) & 0x01) << 2)
  popcount34_idk9_out = (popcount34_idk9_out) | (((popcount34_idk9_core_240 >> 0) & 0x01) << 3)
  popcount34_idk9_out = (popcount34_idk9_out) | (((popcount34_idk9_core_245 >> 0) & 0x01) << 4)
  popcount34_idk9_out = (popcount34_idk9_out) | (((popcount34_idk9_core_246 >> 0) & 0x01) << 5)
