...
def popcount20_amum(input_a):
  ...
  popcount20_amum_out = 0
  popcount20_amum_out = (popcount20_amum_out) | ((0x00) << 0)
  popcount20_amum_out = (popcount20_amum_out) | (((popcount20_amum_core_128 >> 0) & 0x01) << 1)
  popcount20_amum_out = (popcount20_amum_out) | (((popcount20_amum_core_133 >> 0) & 0x01) << 2)
  popcount20_amum_out = (popcount20_amum_out) | (((popcount20_amum_core_138 >> 0) & 0x01) << 3)
  popcount20_amum_out = (popcount20_amum_out) | (((popcount20_amum_core_139 >> 0) & 0x01) << 4)
